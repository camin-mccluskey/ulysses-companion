    ...
    <div className="flex flex-col w-1/5 items-start pl-2">
      ...
      <div className="w-full flex flex-col pt-6">
        ...
        {aboutOpen &&
          ...
          <p>The content for this site has been pulled from <a href="www.joyceproject.com">The Joyce Project</a> and is distributed here in accordance with their fair use <a href="https://www.joyceproject.com/pages/fairuse.htm">policy</a></p>
