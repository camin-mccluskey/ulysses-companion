...
const Hades = ({openNote, currentNoteId}) => {
  return (
    <div>
      <p></p>
      <center><Annotation annotationId="060000hades" annotationSelect={() => openNote("060000hades")} activeAnnotationId={currentNoteId}><font size="+2">[6]</font></Annotation></center>
      <br/>
      <Annotation annotationId="060034martincunningham" annotationSelect={() => openNote("060034martincunningham")} activeAnnotationId={currentNoteId}>Martin Cunningham, first, poked his silkhatted head</Annotation> into the creaking
      ...
      <p>
        —{" "}<Annotation annotationId="060026allofus" annotationSelect={() => openNote("060026allofus")} activeAnnotationId={currentNoteId}>Are we all here now?</Annotation> Martin Cunningham asked. Come along, Bloom.
      </p>
      <p>
        Mr Bloom entered and sat in the vacant place. He pulled the door to
        after him and <Annotation annotationId="040011rightright" annotationSelect={() => openNote("040011rightright")} activeAnnotationId={currentNoteId}>slammed it tight till it shut tight.</Annotation> He passed an arm
        through the armstrap and looked seriously from the open carriagewindow
        at <Annotation annotationId="060019theavenue" annotationSelect={() => openNote("060019theavenue")} activeAnnotationId={currentNoteId}>the lowered blinds of the avenue</Annotation>. One dragged aside: an old woman
        peeping. Nose whiteflattened against the pane. Thanking her stars she
        was <Annotation annotationId="060043passover" annotationSelect={() => openNote("060043passover")} activeAnnotationId={currentNoteId}>passed over</Annotation>. Extraordinary the interest they take in a corpse. Glad
        to see us go we give them such trouble coming. Job seems to suit them.
        <Annotation annotationId="060029huggermugger" annotationSelect={() => openNote("060029huggermugger")} activeAnnotationId={currentNoteId}>Huggermugger in corners.</Annotation>  <Annotation annotationId="060045slipperslapper" annotationSelect={() => openNote("060045slipperslapper")} activeAnnotationId={currentNoteId}>Slop about in slipperslappers for fear he'd
      ...
      <p>
        ...
        the avenue passed and <Annotation annotationId="060019theavenue" annotationSelect={() => openNote("060019theavenue")} activeAnnotationId={currentNoteId}>number nine</Annotation> with its craped knocker, door ajar. At
        walking pace.
      </p>
      <p>
        They waited still, their knees jogging, till they had turned and were
        passing along the tramtracks. <Annotation annotationId="060025whatway" annotationSelect={() => openNote("060025whatway")} activeAnnotationId={currentNoteId}>Tritonville road.</Annotation> Quicker. The wheels
      ...
      <p>
        —{" "}<Annotation annotationId="060025whatway" annotationSelect={() => openNote("060025whatway")} activeAnnotationId={currentNoteId}>Irishtown, Martin Cunningham said. Ringsend. Brunswick street.</Annotation>
      </p>
      <p>
      ...
      <p>
        —{" "}<Annotation annotationId="060039fineoldcustom" annotationSelect={() => openNote("060039fineoldcustom")} activeAnnotationId={currentNoteId}>That's a fine old custom, he said. I am glad to see it has not died
        out.</Annotation>
      </p>
      <p>
        ...
        smoother road past <Annotation annotationId="030015irishtown" annotationSelect={() => openNote("030015irishtown")} activeAnnotationId={currentNoteId}>Watery lane</Annotation>. Mr Bloom at gaze saw a lithe young man,
        clad in mourning, a <Annotation annotationId="010097latinquarterhat" annotationSelect={() => openNote("010097latinquarterhat")} activeAnnotationId={currentNoteId}>wide hat</Annotation>.
      </p>
      ...
      <p>
        —{" "}Was that Mulligan cad with him? His <Annotation annotationId="060000hades" annotationSelect={() => openNote("060000hades")} activeAnnotationId={currentNoteId}><i>fidus Achates</i></Annotation>!
      </p>
      <p>
      ...
      <p>
        Mr Bloom smiled joylessly on <Annotation annotationId="060025whatway" annotationSelect={() => openNote("060025whatway")} activeAnnotationId={currentNoteId}>Ringsend road. Wallace Bros the
        bottleworks. Dodder bridge.</Annotation>
      </p>
      <p>
        Richie Goulding and the legal bag. <Annotation annotationId="030113richiegoulding" annotationSelect={() => openNote("030113richiegoulding")} activeAnnotationId={currentNoteId}>Goulding, Collis and Ward he calls
        ...
        <Annotation annotationId="030076backachepills" annotationSelect={() => openNote("030076backachepills")} activeAnnotationId={currentNoteId}>Beginning to tell on him now: that backache of his, I fear. Wife ironing
      ...
      <p>
        ...
        selfwilled man. <Annotation annotationId="060000hades" annotationSelect={() => openNote("060000hades")} activeAnnotationId={currentNoteId}>Full of his son.</Annotation> <Annotation annotationId="080008parallax" annotationSelect={() => openNote("080008parallax")} activeAnnotationId={currentNoteId}>He is right. Something to hand on.</Annotation> If
        ...
        in <Annotation annotationId="040049pleasantoldtimes" annotationSelect={() => openNote("040049pleasantoldtimes")} activeAnnotationId={currentNoteId}>Raymond terrace</Annotation> she was at the window watching the two dogs at it by
        the wall of <Annotation annotationId="010013barracks" annotationSelect={() => openNote("010013barracks")} activeAnnotationId={currentNoteId}>the cease to do evil</Annotation>. And the sergeant grinning up. She<span data-edition="ed1986" data-page="73"></span> had
      ...
      <p>
        —{" "}Did <Annotation annotationId="050037tomkernan" annotationSelect={() => openNote("050037tomkernan")} activeAnnotationId={currentNoteId}>Tom Kernan</Annotation> turn up? Martin Cunningham asked, twirling the peak of
        his beard gently.
      </p>
      <p>
      ...
      <p>
        —{" "}At <Annotation annotationId="060035prospect" annotationSelect={() => openNote("060035prospect")} activeAnnotationId={currentNoteId}>the cemetery</Annotation>, Martin Cunningham said.
      </p>
      <p>
      ...
      <p>
        —{" "}<Annotation annotationId="060016canals" annotationSelect={() => openNote("060016canals")} activeAnnotationId={currentNoteId}>The grand canal</Annotation>, he said.
      </p>
      <p>
        ...
        this chance. Dogs' home over there. <Annotation annotationId="060004athos" annotationSelect={() => openNote("060004athos")} activeAnnotationId={currentNoteId}>Poor old Athos! Be good to Athos,
        Leopold, is my last wish.</Annotation> <Annotation annotationId="040077ourfather" annotationSelect={() => openNote("040077ourfather")} activeAnnotationId={currentNoteId}>Thy will be done.</Annotation> We obey them in the grave.
      ...
      <p>
        ...
        him, Simon, on <Annotation annotationId="110007croppyboy" annotationSelect={() => openNote("110007croppyboy")} activeAnnotationId={currentNoteId}>Ben Dollard's singing of <i>The Croppy Boy</i></Annotation>.
      </p>
      <p>
      ...
      <p>
        ...
        <Annotation annotationId="060030retrospective" annotationSelect={() => openNote("060030retrospective")} activeAnnotationId={currentNoteId}>retrospective arrangement</Annotation>.
      </p>
      <p>
        —{" "}Did you read <Annotation annotationId="060037dandawson" annotationSelect={() => openNote("060037dandawson")} activeAnnotationId={currentNoteId}>Dan Dawson's speech</Annotation>? Martin Cunningham asked.
      </p>
      <p>
      ...
      <p>
        <Annotation annotationId="040002nationalschool" annotationSelect={() => openNote("040002nationalschool")} activeAnnotationId={currentNoteId}>National school.</Annotation> <Annotation annotationId="050050meades" annotationSelect={() => openNote("050050meades")} activeAnnotationId={currentNoteId}>Meade's yard.</Annotation> <Annotation annotationId="050012cabstands" annotationSelect={() => openNote("050012cabstands")} activeAnnotationId={currentNoteId}>The hazard.</Annotation> Only two there now. Nodding.
      ...
      <p>
        <Annotation annotationId="060021concertrooms" annotationSelect={() => openNote("060021concertrooms")} activeAnnotationId={currentNoteId}>Antient concert rooms.</Annotation> Nothing on there. A man in a buff<span data-edition="ed1961" data-page="91"></span> suit with a
        crape armlet. Not much grief there. Quarter mourning. People in law
        perhaps.
      </p>
      <p>
        They went past <Annotation annotationId="060023saintmarks" annotationSelect={() => openNote("060023saintmarks")} activeAnnotationId={currentNoteId}>the bleak pulpit of saint Mark's</Annotation>, under <Annotation annotationId="050006looplinebridge" annotationSelect={() => openNote("050006looplinebridge")} activeAnnotationId={currentNoteId}>the railway
        bridge</Annotation>, past the <Annotation annotationId="060032queenstheatre" annotationSelect={() => openNote("060032queenstheatre")} activeAnnotationId={currentNoteId}>Queen's theatre</Annotation>: in silence. Hoardings: <Annotation annotationId="060003eugenestratton" annotationSelect={() => openNote("060003eugenestratton")} activeAnnotationId={currentNoteId}>Eugene
        Stratton</Annotation>, Mrs Bandmann Palmer. <Annotation annotationId="050032leah" annotationSelect={() => openNote("050032leah")} activeAnnotationId={currentNoteId}>Could I go to see <em>Leah</em> tonight, I wonder.</Annotation>
        ...
        <Annotation annotationId="060040gaietytheatre" annotationSelect={() => openNote("060040gaietytheatre")} activeAnnotationId={currentNoteId}>Martin Cunningham could work a pass for the Gaiety.</Annotation> Have to stand a
      ...
      <p>
        <Annotation annotationId="040062bolandsbread" annotationSelect={() => openNote("040062bolandsbread")} activeAnnotationId={currentNoteId}>Plasto's.</Annotation> Sir Philip <Annotation annotationId="060022sirphilip" annotationSelect={() => openNote("060022sirphilip")} activeAnnotationId={currentNoteId}>Crampton's memorial fountain bust.</Annotation> Who was he?
      </p>
      <p>
      ...
      <p>
        Mr Dedalus bent across to salute. From the door of <Annotation annotationId="060020redbank" annotationSelect={() => openNote("060020redbank")} activeAnnotationId={currentNoteId}>the Red Bank</Annotation> the
      ...
      <p>
        ...
        topnobbers. <Annotation annotationId="040094jcdoyle" annotationSelect={() => openNote("040094jcdoyle")} activeAnnotationId={currentNoteId}>J. C. Doyle and John MacCormack I hope</Annotation> and. The best, in
        fact.
      </p>
      <p>
      ...
      <p>
        ...
        them. <Annotation annotationId="040031smithobrien" annotationSelect={() => openNote("040031smithobrien")} activeAnnotationId={currentNoteId}>Smith O'Brien. Someone has laid a bunch of flowers there. Woman.
      ...
      <p>
        <Annotation annotationId="040082highgradeha" annotationSelect={() => openNote("040082highgradeha")} activeAnnotationId={currentNoteId}> Oot: a dullgarbed old man from the curbstone tendered his wares, his
      ...
      <p>
        ...
        her hair, humming: <Annotation annotationId="040025lacidarem" annotationSelect={() => openNote("040025lacidarem")} activeAnnotationId={currentNoteId}><i>voglio e non vorrei</i>. No: <i>vorrei e non</i>.</Annotation> Looking at
        the tips of her hairs to see if they are split. <Annotation annotationId="040025lacidarem" annotationSelect={() => openNote("040025lacidarem")} activeAnnotationId={currentNoteId}><i>Mi trema un poco
      ...
      <p>
        They passed under <Annotation annotationId="060012liberatorsform" annotationSelect={() => openNote("060012liberatorsform")} activeAnnotationId={currentNoteId}>the hugecloaked Liberator's form</Annotation>.
      </p>
      <p>
      ...
      <p>
        ...
        of <Annotation annotationId="060009elveryselephant" annotationSelect={() => openNote("060009elveryselephant")} activeAnnotationId={currentNoteId}>Elvery's Elephant house</Annotation>, showed them a curved hand open on his spine.
      </p>
      ...
      <p>
        ...
        carriage passed <Annotation annotationId="060008sirjohngray" annotationSelect={() => openNote("060008sirjohngray")} activeAnnotationId={currentNoteId}>Gray's statue</Annotation>.
      </p>
      <p>
        —{" "}<Annotation annotationId="060026allofus" annotationSelect={() => openNote("060026allofus")} activeAnnotationId={currentNoteId}>We have all been there</Annotation>, Martin Cunningham said broadly.
      </p>
      <p>
      ...
      <p>
        <Annotation annotationId="070006nelsonspillar" annotationSelect={() => openNote("070006nelsonspillar")} activeAnnotationId={currentNoteId}>Nelson's pillar.</Annotation>
      </p>
      <span data-edition="ed1939" data-page="72"> </span>
      <p>
        <Annotation annotationId="070006nelsonspillar" annotationSelect={() => openNote("070006nelsonspillar")} activeAnnotationId={currentNoteId}>—{" "}Eight plums a penny! Eight for a penny!</Annotation>
      </p>
      <p>
      ...
      <p>
        <Annotation annotationId="060000hades" annotationSelect={() => openNote("060000hades")} activeAnnotationId={currentNoteId}>Blazing face: redhot. Too much John Barleycorn.</Annotation> Cure for a red nose.
      ...
      <p>
        <Annotation annotationId="060012liberatorsform" annotationSelect={() => openNote("060012liberatorsform")} activeAnnotationId={currentNoteId}>Dead side of the street this.</Annotation> Dull business by day, <Annotation annotationId="060013catholicclub" annotationSelect={() => openNote("060013catholicclub")} activeAnnotationId={currentNoteId}>land agents,
        ...
        late <Annotation annotationId="060010fathermathew" annotationSelect={() => openNote("060010fathermathew")} activeAnnotationId={currentNoteId}>Father Mathew</Annotation>. Foundation <Annotation annotationId="060018foundationstone" annotationSelect={() => openNote("060018foundationstone")} activeAnnotationId={currentNoteId}>stone for Parnell. Breakdown. Heart.</Annotation>
      </p>
      <p>
        White horses with white frontlet plumes came round the <Annotation annotationId="060011therotunda" annotationSelect={() => openNote("060011therotunda")} activeAnnotationId={currentNoteId}>Rotunda</Annotation> corner,
      ...
      <p>
        A dwarf's face, <Annotation annotationId="040096sheknew" annotationSelect={() => openNote("040096sheknew")} activeAnnotationId={currentNoteId}>mauve and wrinkled like little Rudy's was</Annotation>. Dwarf's body,
        ...
        nothing. Mistake of nature. <Annotation annotationId="040087poorlittlerudy" annotationSelect={() => openNote("040087poorlittlerudy")} activeAnnotationId={currentNoteId}>If it's healthy it's from the mother. If not
      ...
      <p>
        ...
        clutching rushes. He looked at me. And <Annotation annotationId="050049comehometoma" annotationSelect={() => openNote("050049comehometoma")} activeAnnotationId={currentNoteId}>that awful drunkard of a wife
        of his</Annotation>. Setting up house for her time after time and then pawning the
        furniture on him every Saturday almost. <Annotation annotationId="060000hades" annotationSelect={() => openNote("060000hades")} activeAnnotationId={currentNoteId}>Leading him the life of the
      ...
      <p>
        As they turned into <Annotation annotationId="060002berkeleystreet" annotationSelect={() => openNote("060002berkeleystreet")} activeAnnotationId={currentNoteId}>Berkeley street</Annotation> a streetorgan near the Basin sent
        over and after them <Annotation annotationId="040076musichall" annotationSelect={() => openNote("040076musichall")} activeAnnotationId={currentNoteId}>a rollicking rattling song of the halls</Annotation>. Has anybody
        here seen Kelly? Kay ee double ell wy. Dead March from <i>Saul.</i> He's
        as bad as old Antonio. He left me on my ownio. Pirouette! <Annotation annotationId="010068themater" annotationSelect={() => openNote("010068themater")} activeAnnotationId={currentNoteId}>The <i>Mater
        ...
        Deadhouse handy underneath. Where <Annotation annotationId="060015riordan" annotationSelect={() => openNote("060015riordan")} activeAnnotationId={currentNoteId}>old Mrs Riordan</Annotation> died. They look
        ...
        that was dressed that bite the bee gave me. He's gone over to <Annotation annotationId="040086mrsthornton" annotationSelect={() => openNote("040086mrsthornton")} activeAnnotationId={currentNoteId}>the
      ...
      <p>
        Thursday, of course. <Annotation annotationId="040037cattlemarket" annotationSelect={() => openNote("040037cattlemarket")} activeAnnotationId={currentNoteId}>Tomorrow is killing day.</Annotation> Springers. Cuffe sold them
      ...
      <p>
        —{" "}I can't make out why <Annotation annotationId="060033corporation" annotationSelect={() => openNote("060033corporation")} activeAnnotationId={currentNoteId}>the corporation</Annotation> doesn't run a tramline from the
      ...
      <p>
        ...
        <Annotation annotationId="060039fineoldcustom" annotationSelect={() => openNote("060039fineoldcustom")} activeAnnotationId={currentNoteId}>municipal funeral trams like they have in Milan, you know. Run the line
      ...
      <p>
        ...
        the hearse capsized <Annotation annotationId="060014dunphyscorner" annotationSelect={() => openNote("060014dunphyscorner")} activeAnnotationId={currentNoteId}>round Dunphy's</Annotation> and upset the coffin on to the road.
      </p>
      <p>
      ...
      <p>
        <Annotation annotationId="060016canals" annotationSelect={() => openNote("060016canals")} activeAnnotationId={currentNoteId}>Crossguns bridge: the royal canal.</Annotation>
      </p>
      <p>
        <Annotation annotationId="060016canals" annotationSelect={() => openNote("060016canals")} activeAnnotationId={currentNoteId}>Water rushed roaring through the sluices. A man stood on his
      ...
      <p>
        ...
        over slime, mudchoked bottles, carrion dogs. Athlone, <Annotation annotationId="010126mullingar" annotationSelect={() => openNote("010126mullingar")} activeAnnotationId={currentNoteId}>Mullingar</Annotation>,
        ...
        the auction but a lady's. Developing waterways. <Annotation annotationId="060031ferry" annotationSelect={() => openNote("060031ferry")} activeAnnotationId={currentNoteId}>James M'Cann's hobby
        ...
        writing. Come as a surprise, Leixlip, Clonsilla. <Annotation annotationId="060036bogs" annotationSelect={() => openNote("060036bogs")} activeAnnotationId={currentNoteId}>Dropping down lock by
        lock to Dublin. With turf from the midland bogs.</Annotation> Salute. He lifted his
        brown straw hat, saluting Paddy Dignam.
      </p>
      <p>
        They drove on past <Annotation annotationId="060017brianboroimhehouse" annotationSelect={() => openNote("060017brianboroimhehouse")} activeAnnotationId={currentNoteId}>Brian Boroimhe house</Annotation>. Near it now.
      </p>
      <p>
        —{" "}I wonder <Annotation annotationId="050037tomkernan" annotationSelect={() => openNote("050037tomkernan")} activeAnnotationId={currentNoteId}>how is our friend Fogarty getting on</Annotation>, Mr Power said.
      </p>
      <p>
      ...
      <p>
        The carriage steered left for <Annotation annotationId="060035prospect" annotationSelect={() => openNote("060035prospect")} activeAnnotationId={currentNoteId}>Finglas road</Annotation>.
      </p>
      <p>
        <Annotation annotationId="060046monumental" annotationSelect={() => openNote("060046monumental")} activeAnnotationId={currentNoteId}>The stonecutter's yard on the right. Last lap.</Annotation> <Annotation annotationId="060000hades" annotationSelect={() => openNote("060000hades")} activeAnnotationId={currentNoteId}>Crowded on the spit of
        ...
        appealing.</Annotation> <Annotation annotationId="060046monumental" annotationSelect={() => openNote("060046monumental")} activeAnnotationId={currentNoteId}>The best obtainable. Thos. H. Dennany, monumental builder and
        sculptor.</Annotation>
      </p>
      <p>
        Passed.
      ...
      <p>
        <Annotation annotationId="060035prospect" annotationSelect={() => openNote("060035prospect")} activeAnnotationId={currentNoteId}>The high railings of Prospect</Annotation> rippled past their gaze. Dark poplars,
        rare white forms. Forms more frequent, white shapes thronged amid the
        trees, white forms and fragments streaming by <Annotation annotationId="010070mutes" annotationSelect={() => openNote("010070mutes")} activeAnnotationId={currentNoteId}>mutely, sustaining vain
      ...
      <p>
        ...
        He stepped out of the carriage, replacing <Annotation annotationId="050021freeman" annotationSelect={() => openNote("050021freeman")} activeAnnotationId={currentNoteId}>the newspaper his other hand
      ...
      <p>
        ...
        every day? Must be twenty or thirty funerals every day. Then <Annotation annotationId="050025botanicgardens" annotationSelect={() => openNote("050025botanicgardens")} activeAnnotationId={currentNoteId}>Mount
      ...
      <p>
        <Annotation annotationId="010070mutes" annotationSelect={() => openNote("010070mutes")} activeAnnotationId={currentNoteId}>The mutes</Annotation> shouldered the coffin and bore it in through the gates. So much 
      ...
      <p>
        ...
        towards <Annotation annotationId="060035prospect" annotationSelect={() => openNote("060035prospect")} activeAnnotationId={currentNoteId}>the cardinal's mausoleum</Annotation>. Speaking.
      </p>
      <p>
      ...
      <p>
        ...
        since the old queen died. <Annotation annotationId="060028frogmore" annotationSelect={() => openNote("060028frogmore")} activeAnnotationId={currentNoteId}>Drawn on
      ...
      <p>
        —{" "}<Annotation annotationId="010098metbutterly" annotationSelect={() => openNote("010098metbutterly")} activeAnnotationId={currentNoteId}>Nothing between himself and heaven</Annotation>, Ned Lambert answered.
      </p>
      <p>
      ...
      <p>
        ...
        pointing ahead. A few bob a skull. Just to keep them going <Annotation annotationId="130007scottishwidows" annotationSelect={() => openNote("130007scottishwidows")} activeAnnotationId={currentNoteId}>till the
      ...
      <p>
        They halted about the door of the <Annotation annotationId="060035prospect" annotationSelect={() => openNote("060035prospect")} activeAnnotationId={currentNoteId}>mortuary chapel</Annotation>. Mr Bloom stood behind
      ...
      <p>
        ...
        knelt here and there in prayingdesks. Mr Bloom stood behind near <Annotation annotationId="050023holywater" annotationSelect={() => openNote("050023holywater")} activeAnnotationId={currentNoteId}>the
      ...
      <p>
        <Annotation annotationId="010084server" annotationSelect={() => openNote("010084server")} activeAnnotationId={currentNoteId}>A server</Annotation> bearing a brass bucket with something in it came out through a
        door. The whitesmocked priest came after him, <Annotation annotationId="010104stole" annotationSelect={() => openNote("010104stole")} activeAnnotationId={currentNoteId}>tidying his stole</Annotation> with one
        hand, balancing with the other a little book against his toad's belly.
        <Annotation annotationId="060006toadeyes" annotationSelect={() => openNote("060006toadeyes")} activeAnnotationId={currentNoteId}>Who'll read the book? I, said the rook.</Annotation>
      </p>
      <p>
      ...
      <p>
        Father Coffey. I knew his name was like a coffin. <i>Domine-namine.</i> <Annotation annotationId="060000hades" annotationSelect={() => openNote("060000hades")} activeAnnotationId={currentNoteId}>Bully
      ...
      <p>
        ...
        gloom kicking his heels waiting for the next please. <Annotation annotationId="060006toadeyes" annotationSelect={() => openNote("060006toadeyes")} activeAnnotationId={currentNoteId}>Eyes of a toad too.</Annotation>
      ...
      <p>
        <Annotation annotationId="050023holywater" annotationSelect={() => openNote("050023holywater")} activeAnnotationId={currentNoteId}>The priest took a stick with a knob at the end of it out of the boy's
      ...
      <p>
        Mr Power's soft eyes went up to the apex of <Annotation annotationId="060027loftycone" annotationSelect={() => openNote("060027loftycone")} activeAnnotationId={currentNoteId}>the lofty cone</Annotation>.
      </p>
      <span data-edition="ed1961" data-page="104"></span>
      <p>
        —{" "}He's at rest, he said, in the middle of his people, old Dan O'. <Annotation annotationId="020038oconnell" annotationSelect={() => openNote("020038oconnell")} activeAnnotationId={currentNoteId}>But
      ...
      <p>
        ...
        dead. That last day idea. Knocking them all up out of their graves. <Annotation annotationId="010098metbutterly" annotationSelect={() => openNote("010098metbutterly")} activeAnnotationId={currentNoteId}>Come
      ...
      <p>
        ...
        time. She was a finelooking woman. <Annotation annotationId="170008precedingseries" annotationSelect={() => openNote("170008precedingseries")} activeAnnotationId={currentNoteId}>I danced with her, wait, fifteen
      ...
      <p>
        —{" "}Did you hear that one, he asked them, about Mulcahy from <Annotation annotationId="050014thecoombe" annotationSelect={() => openNote("050014thecoombe")} activeAnnotationId={currentNoteId}>the Coombe</Annotation>?
      </p>
      <p>
      ...
      <p>
        ...
        the man</i>, says he. <Annotation annotationId="010098metbutterly" annotationSelect={() => openNote("010098metbutterly")} activeAnnotationId={currentNoteId}><i>That's not Mulcahy</i></Annotation>, says he, <i>whoever done it</i>.
      </p>
      <p>
      ...
      <p>
        ...
        the grey. <Annotation annotationId="060000hades" annotationSelect={() => openNote("060000hades")} activeAnnotationId={currentNoteId}>Fancy being his wife. Wonder</Annotation><span data-edition="ed1961" data-page="107"></span> <Annotation annotationId="060000hades" annotationSelect={() => openNote("060000hades")} activeAnnotationId={currentNoteId}>how he had the gumption to propose to
        ...
        churchyards yawn and <Annotation annotationId="020038oconnell" annotationSelect={() => openNote("020038oconnell")} activeAnnotationId={currentNoteId}>Daniel O'Connell must be a descendant I suppose
        ...
        same like a big giant in the dark. <Annotation annotationId="150004willowisp" annotationSelect={() => openNote("150004willowisp")} activeAnnotationId={currentNoteId}>Will o' the wisp.</Annotation> Gas of graves.
        ...
        ends meet. <Annotation annotationId="060000hades" annotationSelect={() => openNote("060000hades")} activeAnnotationId={currentNoteId}>Tantalising for the poor dead. Smell of grilled beefsteaks to
      ...
      <p>
        ...
        poppies growing produce the best opium Mastiansky told me. <Annotation annotationId="050025botanicgardens" annotationSelect={() => openNote("050025botanicgardens")} activeAnnotationId={currentNoteId}>The Botanic
      ...
      <p>
        ...
        swirling with them. <Annotation annotationId="040069seasidegirls" annotationSelect={() => openNote("040069seasidegirls")} activeAnnotationId={currentNoteId}>Your head it simply swurls. Those pretty little
        ...
        Cracking his jokes too: <Annotation annotationId="030080cockles" annotationSelect={() => openNote("030080cockles")} activeAnnotationId={currentNoteId}>warms the cockles of his heart</Annotation>. The one about
      ...
      <p>
        Nice soft tweed Ned Lambert has in that suit.  <Annotation annotationId="020080mauve" annotationSelect={() => openNote("020080mauve")} activeAnnotationId={currentNoteId}>Tinge of purple.</Annotation> I had
        one like that <Annotation annotationId="040049pleasantoldtimes" annotationSelect={() => openNote("040049pleasantoldtimes")} activeAnnotationId={currentNoteId}>when we lived in Lombard street west</Annotation>. Dressy fellow he was
      ...
      <p>
        <Annotation annotationId="030087pastlife" annotationSelect={() => openNote("030087pastlife")} activeAnnotationId={currentNoteId}>If we were all suddenly somebody else.</Annotation>
      </p>
      <p>
        <Annotation annotationId="060044donkey" annotationSelect={() => openNote("060044donkey")} activeAnnotationId={currentNoteId}>Far away a donkey brayed.</Annotation> <Annotation annotationId="060044donkey" annotationSelect={() => openNote("060044donkey")} activeAnnotationId={currentNoteId}>Rain. No such ass. Never see a dead one, they
      ...
      <p>
        ...
        you. Mine over there <Annotation annotationId="060035prospect" annotationSelect={() => openNote("060035prospect")} activeAnnotationId={currentNoteId}>towards Finglas</Annotation>, the plot I bought. Mamma, poor
      ...
      <p>
        ...
        traversed the <Annotation annotationId="060000hades" annotationSelect={() => openNote("060000hades")} activeAnnotationId={currentNoteId}>dismal fields</Annotation>.
      </p>
      ...
      <p>
        —{" "}I am just taking the names, Hynes said below his breath. <Annotation annotationId="060026allofus" annotationSelect={() => openNote("060026allofus")} activeAnnotationId={currentNoteId}> What is your
      ...
      <p>
        —{" "}<Annotation annotationId="040079mcoy" annotationSelect={() => openNote("040079mcoy")} activeAnnotationId={currentNoteId}>Charley</Annotation>, Hynes said writing. I know. He was on <Annotation annotationId="050021freeman" annotationSelect={() => openNote("050021freeman")} activeAnnotationId={currentNoteId}>the <i>Freeman</i></Annotation> once.
      </p>
      <p>
        ...
        He died of a Tuesday. <Annotation annotationId="060041charley" annotationSelect={() => openNote("060041charley")} activeAnnotationId={currentNoteId}>Got the run. Levanted with the cash of a few ads.
      ...
      <p>
        ...
        the. Has anybody here seen? Kay ee double ell. <Annotation annotationId="010078invisibility" annotationSelect={() => openNote("010078invisibility")} activeAnnotationId={currentNoteId}>Become invisible.</Annotation> Good
      ...
      <p>
        —{" "}Let us go round by <Annotation annotationId="060035prospect" annotationSelect={() => openNote("060035prospect")} activeAnnotationId={currentNoteId}>the chief's grave</Annotation>, Hynes said. We have time.
      </p>
      <p>
      ...
      <p>
        ...
        <Annotation annotationId="060005churchyard" annotationSelect={() => openNote("060005churchyard")} activeAnnotationId={currentNoteId}>Eulogy in a country churchyard it ought to be that poem of whose is it
        ...
        Ideal spot to have a quiet smoke and read <Annotation annotationId="160004newspapers" annotationSelect={() => openNote("160004newspapers")} activeAnnotationId={currentNoteId}>the <i>Church Times</i></Annotation>. Marriage
      ...
      <p>
        ...
        wedding present <Annotation annotationId="060033corporation" annotationSelect={() => openNote("060033corporation")} activeAnnotationId={currentNoteId}>alderman Hooper</Annotation> gave us. Hu! Not a budge out of him.
      ...
      <p>
        <Annotation annotationId="060000hades" annotationSelect={() => openNote("060000hades")} activeAnnotationId={currentNoteId}>How many! All these here once walked round Dublin.</Annotation> Faithful departed. As
      ...
      <p>
        Rtststr! <Annotation annotationId="030038pebbles" annotationSelect={() => openNote("030038pebbles")} activeAnnotationId={currentNoteId}>A rattle of pebbles.</Annotation> Wait. Stop!
      </p>
      <p>
      ...
      <p>
        <Annotation annotationId="010062ghoul" annotationSelect={() => openNote("010062ghoul")} activeAnnotationId={currentNoteId}>An obese grey rat</Annotation> toddled along the side of the crypt, moving the
      ...
      <p>
        <Annotation annotationId="060000hades" annotationSelect={() => openNote("060000hades")} activeAnnotationId={currentNoteId}>The gates glimmered in front: still open. Back to the world again.</Annotation>
        Enough of this place. Brings you a bit nearer every time. <Annotation annotationId="060038emilysinico" annotationSelect={() => openNote("060038emilysinico")} activeAnnotationId={currentNoteId}>Last time I
        ...
        death. There is another world after death named hell. <Annotation annotationId="050003otherworld" annotationSelect={() => openNote("050003otherworld")} activeAnnotationId={currentNoteId}>I do not like that
        ...
        beds. They are not going to get me this innings. Warm beds: <Annotation annotationId="040063happywarmth" annotationSelect={() => openNote("040063happywarmth")} activeAnnotationId={currentNoteId}>warm
      ...
      <p>
        ...
        at first sight.<span data-edition="ed1986" data-page="94"></span> <Annotation annotationId="170008precedingseries" annotationSelect={() => openNote("170008precedingseries")} activeAnnotationId={currentNoteId}>Molly and Floey Dillon linked under the lilactree,
