const Sirens = ({openNote}) => {
  return (
    <div>
      <p></p>
      <center><font size="+2">[11]</font></center>
      <br/>
      <button className="bg-gray-300 bg-center bg-cover hover:bg-green-300" onClick={() => openNote("110009bronzegold")}>Bronze by gold heard the hoofirons, steelyringing.</button>
      <p></p>
      <p>
      ...
      <p>
        Decoy. Soft word. But look! <button className="bg-gray-300 bg-center bg-cover hover:bg-green-300" onClick={() => openNote("110006goodbyesweetheart")}>The bright stars fade.</button> O rose! Notes chirruping
        answer.
        Castile. <button className="bg-gray-300 bg-center bg-cover hover:bg-green-300" onClick={() => openNote("110006goodbyesweetheart")}>The morn is breaking.</button>
      </p>
      <p>
        <button className="bg-gray-300 bg-center bg-cover hover:bg-green-300" onClick={() => openNote("040091jingle")}>Jingle jingle jaunted jingling.</button>
      </p>
      <p>
        Coin rang. Clock clacked.
      </p>
      <p>
        Avowal. <button className="bg-gray-300 bg-center bg-cover hover:bg-green-300" onClick={() => openNote("040091jingle")}><i>Sonnez.</i></button> <button className="bg-gray-300 bg-center bg-cover hover:bg-green-300" onClick={() => openNote("110006goodbyesweetheart")}>I could.</button> Rebound of garter. <button className="bg-gray-300 bg-center bg-cover hover:bg-green-300" onClick={() => openNote("110006goodbyesweetheart")}>Not leave thee.</button> <button className="bg-gray-300 bg-center bg-cover hover:bg-green-300" onClick={() => openNote("040091jingle")}>Smack. <i>La
        cloche!</i> Thigh smack.</button> Avowal. Warm. <button className="bg-gray-300 bg-center bg-cover hover:bg-green-300" onClick={() => openNote("110006goodbyesweetheart")}>Sweetheart, goodbye!</button>
      </p>
      <p>
        Jingle. Bloo.
      </p>
      ...
      <p>
        I feel so sad. P. S. <button className="bg-gray-300 bg-center bg-cover hover:bg-green-300" onClick={() => openNote("050026henryflower")}>So lonely blooming.</button>
      </p>
      <p>
        Listen!
      </p>
      ...
      <p>
        <button className="bg-gray-300 bg-center bg-cover hover:bg-green-300" onClick={() => openNote("110007croppyboy")}>Naminedamine. All gone. All fallen.</button>
      </p>
      <p>
        Tiny, her tremulous fernfoils of maidenhair.
      </p>
      <p>
        <button className="bg-gray-300 bg-center bg-cover hover:bg-green-300" onClick={() => openNote("110007croppyboy")}>Amen! He gnashed in fury.</button>
      </p>
      <p>
      ...
      <p>
        <button className="bg-gray-300 bg-center bg-cover hover:bg-green-300" onClick={() => openNote("110009bronzegold")}>By bronze, by gold, in oceangreen of shadow.</button> Bloom. Old Bloom.
      </p>
      <p>
      ...
      <p>
        ...
        crossblind of <button className="bg-gray-300 bg-center bg-cover hover:bg-green-300" onClick={() => openNote("110010ormondbar")}>the Ormond bar</button> heard the viceregal hoofs go by, ringing
        steel.
      </p>
      <p>
      ...
      <p>
        Miss Douce said yes, sitting with his ex, pearl grey and <button className="bg-gray-300 bg-center bg-cover hover:bg-green-300" onClick={() => openNote("110009bronzegold")}><i>eau de Nil.</i></button>
      </p>
      <p>
      ...
      <p>
        ...
        the pane in <button className="bg-gray-300 bg-center bg-cover hover:bg-green-300" onClick={() => openNote("110009bronzegold")}>a halo</button> of hurried breath.
      </p>
      <p>
      ...
      <p>
        ...
        behind an ear. Sauntering sadly, <button className="bg-gray-300 bg-center bg-cover hover:bg-green-300" onClick={() => openNote("110009bronzegold")}>gold no more</button>, she twisted twined a
        hair.
      </p>
      <p>
      ...
      <p>
        —{" "}<button className="bg-gray-300 bg-center bg-cover hover:bg-green-300" onClick={() => openNote("050049comehometoma")}>It's them has the fine times, sadly then she said.</button>
      </p>
      <p>
        A man.
      </p>
      ...
      <p>
        ...
        <button className="bg-gray-300 bg-center bg-cover hover:bg-green-300" onClick={() => openNote("030063lithiawater")}>lithia crate</button>, safe from eyes, low.
      </p>
      <p>
      ...
      <p>
        —{" "}<button className="bg-gray-300 bg-center bg-cover hover:bg-green-300" onClick={() => openNote("110008leavetohands")}>And leave it to my hands</button>, she said.
      </p>
      <p>
      ...
      <p>
        ...
        night in <button className="bg-gray-300 bg-center bg-cover hover:bg-green-300" onClick={() => openNote("060021concertrooms")}>the Antient Concert Rooms</button>.
      </p>
      ...
      <p>
        <button className="bg-gray-300 bg-center bg-cover hover:bg-green-300" onClick={() => openNote("060006toadeyes")}>Married to Bloom, to greaseaseabloom.</button>
      </p>
      ...
      <p>
        By Cantwell's offices roved Greaseabloom, by <button className="bg-gray-300 bg-center bg-cover hover:bg-green-300" onClick={() => openNote("070019nannetti")}>Ceppi's virgins, bright of
        their oils. Nannetti's father hawked those things about, wheedling at
        doors as I.</button> Religion pays. Must see him about Keyes's par. Eat first. I want.
        Not yet. <button className="bg-gray-300 bg-center bg-cover hover:bg-green-300" onClick={() => openNote("110002atfourshe")}>At four, she said.</button> Time ever passing. Clockhands turning. On.
        Where eat? The Clarence, Dolphin. On. For Raoul. Eat. If I net five
        guineas <span data-edition="ed1961" data-page="260"> </span>with those ads. <button className="bg-gray-300 bg-center bg-cover hover:bg-green-300" onClick={() => openNote("020080mauve")}>The violet silk petticoats.</button> Not yet. The sweets
        of sin.
      </p>
      <p>
      ...
      <p>
        With grace of alacrity towards <button className="bg-gray-300 bg-center bg-cover hover:bg-green-300" onClick={() => openNote("050030cantrellcochrane")}>the mirror gilt Cantrell and Cochrane's</button>
      ...
      <p>
        He looked towards <button className="bg-gray-300 bg-center bg-cover hover:bg-green-300" onClick={() => openNote("110010ormondbar")}>the saloon door</button>.
      </p>
      <p>
      ...
      <p>
        Tink to her pity cried a diner's bell. To <button className="bg-gray-300 bg-center bg-cover hover:bg-green-300" onClick={() => openNote("110010ormondbar")}>the door of the
        diningroom</button> came bald Pat, came bothered Pat, came Pat, waiter of Ormond.
      ...
      <p>
        ...
        For Raoul. He eyed and saw afar on Essex bridge a gay hat riding on a <button className="bg-gray-300 bg-center bg-cover hover:bg-green-300" onClick={() => openNote("050013jauntingcar")}>jaunting car</button>. It is. Third time. Coincidence.
      </p>
      ...
      <p>
        <button className="bg-gray-300 bg-center bg-cover hover:bg-green-300" onClick={() => openNote("110006goodbyesweetheart")}>—{" "}<i>The bright stars fade</i>...</button>
      </p>
      <p>
        <button className="bg-gray-300 bg-center bg-cover hover:bg-green-300" onClick={() => openNote("110006goodbyesweetheart")}>A voiceless song sang from within, singing:</button>
      </p>
      <p>
        <button className="bg-gray-300 bg-center bg-cover hover:bg-green-300" onClick={() => openNote("110006goodbyesweetheart")}>—{" "}... <i>the morn is breaking.</i></button>
      </p>
      <p>
      ...
      <p>
        <button className="bg-gray-300 bg-center bg-cover hover:bg-green-300" onClick={() => openNote("110006goodbyesweetheart")}>—{" "}<i>The dewdrops pearl</i>...</button>
      </p>
      <p>
      ...
      <p>
        ...
        towards <button className="bg-gray-300 bg-center bg-cover hover:bg-green-300" onClick={() => openNote("030113richiegoulding")}>Richie Goulding's legal bag</button>, lifted aloft, saluting.
      </p>
      <p>
        —{" "}<button className="bg-gray-300 bg-center bg-cover hover:bg-green-300" onClick={() => openNote("110006goodbyesweetheart")}><i>And I from thee</i></button>...
      </p>
      <p>
      ...
      <p>
        ...
        Ormond? <button className="bg-gray-300 bg-center bg-cover hover:bg-green-300" onClick={() => openNote("110001bestvalue")}>Best value in Dublin</button>. Is that so? <button className="bg-gray-300 bg-center bg-cover hover:bg-green-300" onClick={() => openNote("110010ormondbar")}>Diningroom. Sit tight there.
        See, not be seen.</button> I think I'll join you. Come on. Richie led on. Bloom
      ...
      <p>
        <button className="bg-gray-300 bg-center bg-cover hover:bg-green-300" onClick={() => openNote("110010ormondbar")}>The bag of Goulding, Collis, Ward led Bloom by ryebloom flowered tables.
        Aimless he chose with agitated aim, bald Pat attending, a table near
        the door. Be near.</button> At four. Has he forgotten? Perhaps a trick. Not come:
      ...
      <p>
        —{" "}... <button className="bg-gray-300 bg-center bg-cover hover:bg-green-300" onClick={() => openNote("110006goodbyesweetheart")}><i>Flora's lips did hie.</i></button>
      </p>
      <p>
      ...
      <p>
        —{" "}<button className="bg-gray-300 bg-center bg-cover hover:bg-green-300" onClick={() => openNote("110006goodbyesweetheart")}><i>I could not leave thee</i></button>...
      </p>
      ...
      <p>
        —{" "}No, now, urged Lenehan. <button className="bg-gray-300 bg-center bg-cover hover:bg-green-300" onClick={() => openNote("040091jingle")}><i>Sonnez la cloche!</i></button> O do! There's no-one.
      </p>
      <p>
      ...
      <p>
        <button className="bg-gray-300 bg-center bg-cover hover:bg-green-300" onClick={() => openNote("110006goodbyesweetheart")}>—{" "}... <i>Sweetheart, goodbye!</i></button>
      </p>
      <p>
      ...
      <p>
        —{" "}<button className="bg-gray-300 bg-center bg-cover hover:bg-green-300" onClick={() => openNote("040092professorgoodwin")}>Poor old Goodwin was the pianist that night</button>, Father Cowley reminded
      ...
      <p>
        Mrs Marion <button className="bg-gray-300 bg-center bg-cover hover:bg-green-300" onClick={() => openNote("030087pastlife")}>met him pike hoses</button>. Smell of burn. <button className="bg-gray-300 bg-center bg-cover hover:bg-green-300" onClick={() => openNote("040003nicename")}>Of Paul de Kock. Nice
        name he.</button>
      </p>
      <p>
      ...
      <p>
        Roll of Bensoulbenjamin rolled to the quivery loveshivery <button className="bg-gray-300 bg-center bg-cover hover:bg-green-300" onClick={() => openNote("110010ormondbar")}>roofpanes</button>.
      </p>
      <p>
      ...
      <p>
        ...
        her outspread <button className="bg-gray-300 bg-center bg-cover hover:bg-green-300" onClick={() => openNote("120009irishindependent")}><i>Independent</i></button>, searching, the lord lieutenant, her
      ...
      <p>
        ...
        screaming, kicking. <button className="bg-gray-300 bg-center bg-cover hover:bg-green-300" onClick={() => openNote("170008precedingseries")}>With all his belongings on show.</button> O saints above,
      ...
      <p>
        <button className="bg-gray-300 bg-center bg-cover hover:bg-green-300" onClick={() => openNote("110010ormondbar")}>Down stage</button> he strode some paces, grave, tall in affliction, his long
        arms outheld. Hoarsely the apple of his throat hoarsed softly. Softly he
        sang to <button className="bg-gray-300 bg-center bg-cover hover:bg-green-300" onClick={() => openNote("110010ormondbar")}>a dusty seascape there</button>: <i>A Last Farewell.</i> A headland, a ship, a
      ...
      <p>
        By Graham Lemon's pineapple rock, by <button className="bg-gray-300 bg-center bg-cover hover:bg-green-300" onClick={() => openNote("060009elveryselephant")}>Elvery's elephant</button> jingle jogged.
      </p>
      <p>
      ...
      <p>
        ...
        <button className="bg-gray-300 bg-center bg-cover hover:bg-green-300" onClick={() => openNote("030076backachepills")}>Backache he. Bright's bright eye. Next item on the programme. Paying the
        piper. Pills, pounded bread, worth a guinea a box. Stave it off awhile.</button>
        ...
        Power. Particular about his drink. Flaw in the glass, <button className="bg-gray-300 bg-center bg-cover hover:bg-green-300" onClick={() => openNote("010010mountains")}>fresh Vartry
        water</button>. Fecking matches from counters to save. Then squander a sovereign
        in dribs and drabs. And when he's wanted <button className="bg-gray-300 bg-center bg-cover hover:bg-green-300" onClick={() => openNote("010019money")}>not a farthing</button>. Screwed
        refusing to pay his fare. Curious types.
      </p>
      <p>
        Never would Richie forget that night. As long as he lived: never. <button className="bg-gray-300 bg-center bg-cover hover:bg-green-300" onClick={() => openNote("110005theatreroyal")}>In the
        gods of the old Royal</button> with little Peake. And when the first note.
      </p>
      <p>
      ...
      <p>
        ...
        Pat, bald Pat is a waiter hard of hearing, to set ajar <button className="bg-gray-300 bg-center bg-cover hover:bg-green-300" onClick={() => openNote("110010ormondbar")}>the door of the
        bar</button>. The door of the bar. So. That will do. Pat, waiter, waited, waiting
      ...
      <p>
        Love that is singing: <button className="bg-gray-300 bg-center bg-cover hover:bg-green-300" onClick={() => openNote("040035oldsweetsong")}>love's old sweet song</button>. Bloom unwound slowly the
      ...
      <p>
        ...
        feet. When will we meet? <button className="bg-gray-300 bg-center bg-cover hover:bg-green-300" onClick={() => openNote("040069seasidegirls")}>My head it simply.</button> Jingle all delighted. He
      ...
      <p>
        Bloom. <button className="bg-gray-300 bg-center bg-cover hover:bg-green-300" onClick={() => openNote("040063happywarmth")}>Flood of warm jimjam lickitup secretness</button> flowed to flow in music
      ...
      <p>
        ...
        Jingle by monuments of <button className="bg-gray-300 bg-center bg-cover hover:bg-green-300" onClick={() => openNote("060008sirjohngray")}>sir John Gray</button>, Horatio onehandled Nelson,
        reverend <button className="bg-gray-300 bg-center bg-cover hover:bg-green-300" onClick={() => openNote("060010fathermathew")}>father Theobald Mathew</button>, jaunted, as said before just now.
        Atrot, in heat, heatseated. <i>Cloche. Sonnez la. Cloche. Sonnez la.</i>
        Slower the mare went up the hill by <button className="bg-gray-300 bg-center bg-cover hover:bg-green-300" onClick={() => openNote("060011therotunda")}>the Rotunda, Rutland square</button>. Too
      ...
      <p>
        ...
        While
        Goulding talked of Barraclough's voice production, while <button className="bg-gray-300 bg-center bg-cover hover:bg-green-300" onClick={() => openNote("060030retrospective")}>Tom Kernan,
        harking back in a retrospective sort of arrangement</button> talked to listening
      ...
      <p>
        Jingle into <button className="bg-gray-300 bg-center bg-cover hover:bg-green-300" onClick={() => openNote("040007dorsetstreet")}>Dorset street</button>.
      </p>
      <p>
      ...
      <p>
        Down the edge of <button className="bg-gray-300 bg-center bg-cover hover:bg-green-300" onClick={() => openNote("050021freeman")}>his <i>Freeman</i> baton</button> ranged Bloom's, your other eye,
      ...
      <p>
        ...
        gulls. Elijah is com. Seven <button className="bg-gray-300 bg-center bg-cover hover:bg-green-300" onClick={() => openNote("080024davybyrnes")}>Davy Byrne's</button>. Is eight about. Say half a
      ...
      <p>
        <button className="bg-gray-300 bg-center bg-cover hover:bg-green-300" onClick={() => openNote("050013jauntingcar")}>A hackney car, number three hundred and twentyfour</button>, driver Barton James
        of number one Harmony avenue, <button className="bg-gray-300 bg-center bg-cover hover:bg-green-300" onClick={() => openNote("050022donnybrook")}>Donnybrook</button>, on which sat a fare, a young
        ...
        a straw hat very dressy, bought of <button className="bg-gray-300 bg-center bg-cover hover:bg-green-300" onClick={() => openNote("040062bolandsbread")}>John Plasto of number one</button> <span data-edition="ed1986" data-page="229"> </span><button className="bg-gray-300 bg-center bg-cover hover:bg-green-300" onClick={() => openNote("040062bolandsbread")}>Great
        Brunswick street, hatter</button>. Eh? This is the jingle that joggled and
        jingled. By <button className="bg-gray-300 bg-center bg-cover hover:bg-green-300" onClick={() => openNote("040060dlugacz")}>Dlugacz' porkshop</button> bright tubes of <button className="bg-gray-300 bg-center bg-cover hover:bg-green-300" onClick={() => openNote("040061agendath")}>Agendath</button> trotted a
      ...
      <p>
        ...
        playing now? Improvising. Intermezzo. P. S. The rum tum tum. <button className="bg-gray-300 bg-center bg-cover hover:bg-green-300" onClick={() => openNote("040017seemtolikeit")}>How will
        you pun? You punish me? Crooked skirt swinging, whack by.</button> Tell me I want
      ...
      <p style={{textIndent:"0cm", textAlign:"center", marginTop:".5cm", marginBottom:".5cm"}}>
        ...
        c/o P. O. <br/>
        <button className="bg-gray-300 bg-center bg-cover hover:bg-green-300" onClick={() => openNote("040041dolphinsbarn")}>Dolphin's barn lane</button><br/>
        {" "}{" "}{" "}{" "}{" "}{" "}{" "}{" "}{" "}
        {" "}{" "}{" "}{" "}{" "}{" "}{" "}{" "}Dublin.
      </p>
      ...
      <p>
        ...
        per col. <button className="bg-gray-300 bg-center bg-cover hover:bg-green-300" onClick={() => openNote("040065matcham")}>Matcham often thinks the laughing witch.</button> Poor Mrs Purefoy. <button className="bg-gray-300 bg-center bg-cover hover:bg-green-300" onClick={() => openNote("080010upup")}>U.
        P.: up.</button>
      </p>
      <p>
      ...
      <p>
        Under <button className="bg-gray-300 bg-center bg-cover hover:bg-green-300" onClick={() => openNote("050037tomkernan")}>Tom Kernan's ginhot words</button> the accompanist wove music slow.
      ...
      <p>
        ...
        <button className="bg-gray-300 bg-center bg-cover hover:bg-green-300" onClick={() => openNote("040069seasidegirls")}>Lovely seaside girls.</button> Skin tanned raw. Should have put on coldcream
      ...
      <p>
        By Larry O'Rourke's, by Larry, <button className="bg-gray-300 bg-center bg-cover hover:bg-green-300" onClick={() => openNote("040081boldlarry")}>bold Larry O'</button>, Boylan swayed and Boylan
        turned.
      </p>
      <p>
      ...
      <p>
        Sea, wind, leaves, thunder, waters, cows lowing, <button className="bg-gray-300 bg-center bg-cover hover:bg-green-300" onClick={() => openNote("040037cattlemarket")}>the cattlemarket</button>,
        cocks, hens don't crow, snakes hissss. There's music everywhere.
        Ruttledge's door: ee creaking. No, that's noise. <button className="bg-gray-300 bg-center bg-cover hover:bg-green-300" onClick={() => openNote("080030cenarteco")}>Minuet of <i>Don
        Giovanni</i> he's playing now. Court dresses of all descriptions in castle
        chambers dancing.</button> Misery. Peasants outside. Green starving faces eating
      ...
      <p>
        O, look we are so! <button className="bg-gray-300 bg-center bg-cover hover:bg-green-300" onClick={() => openNote("110003chambermusic")}>Chamber music. Could make a kind of pun on that.
        It is a kind of music I often thought when she. Acoustics that is.
        Tinkling. Empty vessels make most noise.</button> Because the acoustics, the
      ...
      <p>
        One rapped on a door, one tapped with a knock, did he knock <button className="bg-gray-300 bg-center bg-cover hover:bg-green-300" onClick={() => openNote("040003nicename")}>Paul de Kock</button>
      ...
      <p>
        —{" "}No, Ben, Tom Kernan interfered. <button className="bg-gray-300 bg-center bg-cover hover:bg-green-300" onClick={() => openNote("110007croppyboy")}><i>The Croppy Boy.</i></button> Our native Doric.
      </p>
      <p>
        —{" "}Ay do, Ben, Mr Dedalus said.  <button className="bg-gray-300 bg-center bg-cover hover:bg-green-300" onClick={() => openNote("110007croppyboy")}>Good men and true.</button>
      </p>
      ...
      <p>
        ...
        and painful, come from afar, from hoary mountains, called on <button className="bg-gray-300 bg-center bg-cover hover:bg-green-300" onClick={() => openNote("110007croppyboy")}>good men
        and true. The priest he sought. With him would he speak a word.</button>
      </p>
      <p>
        Tap.
      </p>
      ...
      <p>
        <button className="bg-gray-300 bg-center bg-cover hover:bg-green-300" onClick={() => openNote("110007croppyboy")}>The priest's at home. A false priest's servant bade him welcome. Step
        in. The holy father.</button> Curlycues of chords.
      </p>
      <p>
      ...
      <p>
        The voice of warning, solemn warning, told them <button className="bg-gray-300 bg-center bg-cover hover:bg-green-300" onClick={() => openNote("110007croppyboy")}>the youth had entered
        a lonely hall, told them how solemn fell his footstep there, told them
        the gloomy chamber, the vested priest sitting to shrive.</button>
      </p>
      <p>
        Decent soul. Bit addled now. Thinks he'll win in <i>Answers</i> poets'
        <span data-edition="ed1932" data-page="255"> </span>picture puzzle. We hand you crisp <button className="bg-gray-300 bg-center bg-cover hover:bg-green-300" onClick={() => openNote("010019money")}>five pound note</button>. Bird sitting hatching
      ...
      <p>
        ...
        Ben's contrite beard confessed: <button className="bg-gray-300 bg-center bg-cover hover:bg-green-300" onClick={() => openNote("110007croppyboy")}> <i>in nomine Domini,</i> in God's name. He
        knelt. He beat his hand upon his breast, confessing: <i>mea culpa.</i></button>
      </p>
      <p>
      ...
      <p>
        The sighing voice of sorrow sang. <button className="bg-gray-300 bg-center bg-cover hover:bg-green-300" onClick={() => openNote("110007croppyboy")}>His sins. Since Easter he had cursed
        three times.</button> You bitch's bast. <button className="bg-gray-300 bg-center bg-cover hover:bg-green-300" onClick={() => openNote("110007croppyboy")}>And once at masstime he had gone to play.
        Once by the churchyard he had passed and for his mother's rest he had
        not prayed.</button> A boy. A croppy boy.
      </p>
      <p>
      ...
      <p>
        ...
        listening. Eyes like that. She bent. <button className="bg-gray-300 bg-center bg-cover hover:bg-green-300" onClick={() => openNote("170008precedingseries")}>Chap in dresscircle staring down
        into her with his operaglass for all he was worth.</button> Beauty of music <span data-edition="ed1986" data-page="233"> </span>you
      ...
      <p>
        <button className="bg-gray-300 bg-center bg-cover hover:bg-green-300" onClick={() => openNote("110007croppyboy")}>All gone. All fallen. At the siege of Ross his father, at Gorey all his
        brothers fell. To Wexford</button>, we are the boys of Wexford, <button className="bg-gray-300 bg-center bg-cover hover:bg-green-300" onClick={() => openNote("110007croppyboy")}>he would. Last of
        his name and race.</button>
      </p>
      <p>
        I too. <button className="bg-gray-300 bg-center bg-cover hover:bg-green-300" onClick={() => openNote("040054saltcloak")}>Last of my race.</button> Milly young student. Well, my fault perhaps. No
        son. Rudy. Too late now. Or if not? If not? If still?
      </p>
      <p>
        <button className="bg-gray-300 bg-center bg-cover hover:bg-green-300" onClick={() => openNote("110007croppyboy")}>He bore no hate.</button>
      </p>
      <p>
      ...
      <p>
        Ireland comes now. <button className="bg-gray-300 bg-center bg-cover hover:bg-green-300" onClick={() => openNote("110007croppyboy")}>My country above the king.</button> She listens. <button className="bg-gray-300 bg-center bg-cover hover:bg-green-300" onClick={() => openNote("100012evildays")}>Who fears to
        speak of nineteen four?</button> Time to be shoving. Looked enough.
      </p>
      <p>
        —{" "} <button className="bg-gray-300 bg-center bg-cover hover:bg-green-300" onClick={() => openNote("110007croppyboy")}> <i>Bless me, father,</i> Dollard the croppy cried. <i>Bless me and let me
        go.</i></button>
      </p>
      <p>
        Tap.
      ...
      <p>
        Low sank the music, air and words. Then hastened. <button className="bg-gray-300 bg-center bg-cover hover:bg-green-300" onClick={() => openNote("110007croppyboy")}>The false priest
        rustling soldier from his cassock. A yeoman captain.</button> They know it all by
      ...
      <p>
        ...
        Gold in your pocket, brass in your face. With look to look. Songs without words. <button className="bg-gray-300 bg-center bg-cover hover:bg-green-300" onClick={() => openNote("170008precedingseries")}>Molly, that hurdygurdy boy.</button>
      ...
      <p>
        <button className="bg-gray-300 bg-center bg-cover hover:bg-green-300" onClick={() => openNote("110007croppyboy")}>With hoarse rude fury the yeoman cursed</button>, swelling in apoplectic bitch's
        bastard. <button className="bg-gray-300 bg-center bg-cover hover:bg-green-300" onClick={() => openNote("110007croppyboy")}>A good thought, boy, to come. One hour's your time to live,
        your last.</button>
      </p>
      <p>
        Tap. Tap.
      ...
      <p>
        <button className="bg-gray-300 bg-center bg-cover hover:bg-green-300" onClick={() => openNote("110008leavetohands")}>On the smooth jutting beerpull laid Lydia hand, lightly, plumply, leave
        ...
        through their sliding ring.</button>
      </p>
      <p>
      ...
      <p>
        <button className="bg-gray-300 bg-center bg-cover hover:bg-green-300" onClick={() => openNote("110007croppyboy")}>I hold this house. Amen. He gnashed in fury. Traitors swing.</button>
      </p>
      <p>
      ...
      <p>
        ...
        <button className="bg-gray-300 bg-center bg-cover hover:bg-green-300" onClick={() => openNote("050021freeman")}>Can leave that Freeman.</button> Letter I have. Suppose she were the? No. Walk, walk,
      ...
      <p>
        <button className="bg-gray-300 bg-center bg-cover hover:bg-green-300" onClick={() => openNote("110007croppyboy")}>At Geneva barrack that young man died. At Passage was his body laid.</button>
      ...
      <p>
        Pray for him, prayed the bass of Dollard. <button className="bg-gray-300 bg-center bg-cover hover:bg-green-300" onClick={() => openNote("110007croppyboy")}>You who hear in peace. Breathe
        a prayer, drop a tear, good men, good people. He was the croppy boy.</button>
      </p>
      <span data-edition="ed1932" data-page="258"> </span>
      <p>
        Scaring eavesdropping boots croppy bootsboy Bloom in <button className="bg-gray-300 bg-center bg-cover hover:bg-green-300" onClick={() => openNote("110010ormondbar")}>the Ormond hallway</button>
      ...
      <p>
        ...
        comb and tissuepaper you can knock a tune out of. Molly in her shift <button className="bg-gray-300 bg-center bg-cover hover:bg-green-300" onClick={() => openNote("040049pleasantoldtimes")}>in
        Lombard street west</button>, hair down. I suppose each kind of trade made its
