const Eumaeus = ({openNote}) => {
  return (
    <div>
      ...
      the shavings and handed Stephen the hat and ashplant and <button className="bg-gray-300 bg-center bg-cover hover:bg-green-300" onClick={() => openNote("050045samaritan")}>bucked him up
      generally in orthodox Samaritan fashion which he very badly needed</button>. His
      ...
      Bloom in view of the hour it was and there being no pump of <button className="bg-gray-300 bg-center bg-cover hover:bg-green-300" onClick={() => openNote("010010mountains")}>Vartry water</button>
      available for their ablutions let alone drinking purposes hit upon an
      expedient by suggesting, off the reel, the propriety of <button className="bg-gray-300 bg-center bg-cover hover:bg-green-300" onClick={() => openNote("050051shelter")}>the cabman's
      shelter, as it was called, hardly a stonesthrow away near Butt bridge</button>
      ...
      then condition, both of them being <button className="bg-gray-300 bg-center bg-cover hover:bg-green-300" onClick={() => openNote("040082highgradeha")}>e.d.ed</button>, particularly Stephen, always
      ...
      <p></p>
      <span data-edition="ed1922" data-page="569"> </span><span data-edition="ed1932" data-page="523"> </span>
      <p>
        ...
        <span data-edition="ed1986" data-page="501"> </span>by the circumstance that one of the back buttons of his trousers had,
        <span data-edition="ed1961" data-page="613"> </span>to vary the timehonoured adage, gone the way of all buttons though,
        ...
        for time, 
        <span data-edition="ed1939" data-page="431"> </span>
        ...
        jarvey. As it so happened a <button className="bg-gray-300 bg-center bg-cover hover:bg-green-300" onClick={() => openNote("070003tramwaycompany")}>Dublin United Tramways Company</button>'s sandstrewer
        ...
        Between this point and the high at present unlit warehouses of <button className="bg-gray-300 bg-center bg-cover hover:bg-green-300" onClick={() => openNote("160007shipofthestreet")}>Beresford
        place</button> Stephen thought to think of Ibsen, associated with Baird's the
        ...
        of <button className="bg-gray-300 bg-center bg-cover hover:bg-green-300" onClick={() => openNote("040077ourfather")}>our daily bread</button>, of all commodities of the public the primary and
      ...
      <p>
        <i>En route,</i> to his taciturn and, not to put too fine a point on it, not
        ...
        spoke a word of caution <i>re</i> the dangers of nighttown, women of ill fame
        ...
        <span data-edition="ed1932" data-page="524"> </span>administer a nasty kick if you didn't look out. Highly providential
        was the appearance on the scene of Corny Kelleher when Stephen <span data-edition="ed1922" data-page="570"> </span>was blissfully unconscious that, but for that man in the gap turning up at the
        eleventh hour the finis might have been that he might have <span data-edition="ed1961" data-page="614"> </span>been a
        ...
        the spot <span data-edition="ed1986" data-page="502"> </span>when wanted but in quiet parts of the city, Pembroke road for
        example, the guardians of the law were well in evidence, the obvious reason being
        ...
        of the <i>demimonde</i> ran away with a lot of £. s. d. into the bargain and
        ...
        wine in season as both nourishing and 
        bloodmaking and possessing aperient virtues (notably a 
        <span data-edition="ed1939" data-page="432"> </span>
        ...
        of Stephen by all his pubhunting <i>confrères</i> but one, a most glaring
      ...
      <p>
        ...
        of the Customhouse and passed under <button className="bg-gray-300 bg-center bg-cover hover:bg-green-300" onClick={() => openNote("050006looplinebridge")}>the Loop Line bridge</button> where a brazier
        ...
        figure of the <button className="bg-gray-300 bg-center bg-cover hover:bg-green-300" onClick={() => openNote("060033corporation")}>corporation</button> watchman inside the gloom of the <span data-edition="ed1932" data-page="525"> </span>sentrybox. He
        ...
        him no small effort before he remembered
      ...
      <p>
        ...
        saluted again, calling: <i>Night!</i> Stephen of course started 
        rather dizzily and stopped to return the
        ...
        nevertheless remained on the <i>qui vive</i> with just a shade of anxiety
        ...
        Thames embankment category <span data-edition="ed1986" data-page="503"> </span>they might be hanging about there or simply
      ...
      <p>
        ...
        Rumour had it (though not proved) that <button className="bg-gray-300 bg-center bg-cover hover:bg-green-300" onClick={() => openNote("030150malahide")}>she descended from the house of
        ...
        the distinction of being in service in the washkitchen</button>. This therefore
      ...
      <p>
        ...
        <button className="bg-gray-300 bg-center bg-cover hover:bg-green-300" onClick={() => openNote("010019money")}>Not as much as a farthing</button> to purchase a night's <span data-edition="ed1961" data-page="616"> </span>lodgings. His friends
        ...
        to do. No, it was the daughter of the 
        <span data-edition="ed1922" data-page="572"> </span>
        mother in the washkitchen that
      ...
      <p>
        ...
        tart off the street. There was <button className="bg-gray-300 bg-center bg-cover hover:bg-green-300" onClick={() => openNote("160005dosshouse")}>a dosshouse in Marlborough street, Mrs
        Maloney's</button>, but it was only <button className="bg-gray-300 bg-center bg-cover hover:bg-green-300" onClick={() => openNote("010019money")}>a tanner</button> touch and full of undesirables but
        ...
        addressed of friar Bacon) for <button className="bg-gray-300 bg-center bg-cover hover:bg-green-300" onClick={() => openNote("010019money")}>a bob</button>. He was starving too though he
      ...
      <p>
        ...
        deserving of much credence. However <i>haud ignarus malorum miseris
        succurrere disco,</i> etcetera, as the Latin poet remarks, especially as luck
        ...
        there, <span data-edition="ed1961" data-page="617"> </span>but thinking he might lend him anything up to a bob or so in lieu
        ...
        <span data-edition="ed1932" data-page="527"> </span>He tried his hardest to recollect for the moment whether he had lost
        ...
        <span data-edition="ed1922" data-page="573"> </span>
      ...
      <p>
        —{" "}<button className="bg-gray-300 bg-center bg-cover hover:bg-green-300" onClick={() => openNote("010019money")}>Those are halfcrowns</button>, man, Corley corrected him.
      </p>
      <p>
      ...
      <p>
        ...
        word for us to get me taken 
        <span data-edition="ed1939" data-page="434"> </span>
        on there. I'd carry a sandwichboard only
      ...
      <p>
        ...
        the night before last and fined <button className="bg-gray-300 bg-center bg-cover hover:bg-green-300" onClick={() => openNote("010019money")}>ten bob</button> for a drunk and disorderly and
      ...
      <p>
        ...
        was <span data-edition="ed1986" data-page="505"> </span>having a quiet forty winks for all intents and purposes on his own
        ...
        Being a levelheaded individual <span data-edition="ed1961" data-page="618"> </span>who could give points to not a few in
        ...
        impecuniosity. Probably he was one of his hangerson but for the
        matter of that it was merely a question of one preying on his nextdoor
        neighbour all round, in every deep, so to put it, a deeper <span data-edition="ed1932" data-page="528"> </span>depth and for
        ...
        a very <i>rara avis</i> altogether. In any case he had a consummate amount of
        cool assurance 
        <span data-edition="ed1922" data-page="574"> </span>
      ...
      <p>
        ...
        <button className="bg-gray-300 bg-center bg-cover hover:bg-green-300" onClick={() => openNote("070015buttbridge")}>moored alongside Customhouse quay</button> and quite possibly out of repair,
      ...
      <span data-edition="ed1939" data-page="435"> </span>
      <p>
        —{" "}To seek misfortune, was Stephen's answer.
      </p>
      <span data-edition="ed1961" data-page="619"> </span>
      <p>
      ...
      <span data-edition="ed1986" data-page="506"> </span>
      <p>
      ...
      <p>
        ...
        <span data-edition="ed1932" data-page="529"> </span>hazarded, still thinking of the very unpleasant scene at Westland Row
        terminus when it 
        <span data-edition="ed1922" data-page="575"> </span>
        was perfectly evident that the other two, Mulligan,
      ...
      <p>
        ...
        surprise to learn that <button className="bg-gray-300 bg-center bg-cover hover:bg-green-300" onClick={() => openNote("100002tobacco")}>a pinch of tobacco or some narcotic</button> was put in
      ...
      <p>
        ...
        fair to enjoy a flourishing <span data-edition="ed1961" data-page="620"> </span>practice in the not too distant future as
        ...
        aid <button className="bg-gray-300 bg-center bg-cover hover:bg-green-300" onClick={() => openNote("030150malahide")}>at Skerries, or Malahide was it?</button>, was, he was bound to admit, an
      ...
      <p>
        ...
        friendliness which he gave at Stephen's at present morose expression of <span data-edition="ed1932" data-page="530"></span>features 
        <span data-edition="ed1922" data-page="576"> </span>
        did not throw a flood of light, none at all in fact on the
        problem as <span data-edition="ed1986" data-page="507"> </span>to whether he had let himself be badly bamboozled to judge by
        ...
        allowed matters to more or less... Grinding poverty did have 
        <span data-edition="ed1939" data-page="436"> </span>
        that effect
      ...
      <p>
        Adjacent to the men's public urinal they perceived <button className="bg-gray-300 bg-center bg-cover hover:bg-green-300" onClick={() => openNote("050047hokypoky")}>an icecream car</button> round
      ...
      <p>
        —{" "}<i>Puttana madonna, che ci dia i quattrini! Ho ragione? Culo rotto!</i>
      </p>
      <p>
        <i>—{" "}Intendiamoci. Mezzo sovrano piu...</i>
      </p>
      <p>
        <i>—{" "}Dice lui, pero!</i>
      </p>
      ...
      <p>
        Mr Bloom and Stephen entered <button className="bg-gray-300 bg-center bg-cover hover:bg-green-300" onClick={() => openNote("050051shelter")}>the cabman's shelter, an unpretentious
        wooden structure</button>, where, prior to then, he had rarely if ever been
        ...
        of waifs and strays and other nondescript specimens of the genus <i>homo,</i>
        already there engaged in eating <span data-edition="ed1961" data-page="621"> </span>and drinking, diversified by conversation,
      ...
      <p>
        ...
        <button className="bg-gray-300 bg-center bg-cover hover:bg-green-300" onClick={() => openNote("160006icebergs")}>to break the ice</button>, it occurs to me you ought to sample something in the
        shape of solid food, say, a roll of some description.
      </p>
      <p>
        Accordingly his first act was with characteristic <i>sangfroid</i> to order
        these commodities quietly. The <i>hoi polloi</i> of jarvies or stevedores,
      ...
      <p>
        Mr Bloom, availing himself of the right of free speech, he having
        just a bowing acquaintance with the language in dispute, though, to be
        sure, <span data-edition="ed1932" data-page="531"> </span>rather in a quandary over <i>voglio</i>, remarked to his <i>protégé</i> in
        an audible tone of voice, 
        <span data-edition="ed1922" data-page="577"> </span>
        <i>apropos</i> of the battle royal in the street
        which was still raging fast and furious:
      </p>
      <p>
        —{" "}A beautiful language. I mean for singing purposes. Why do you not
        write your poetry in that language? <i>Bella Poetria!</i> It is so melodious
        and full. <i>Belladonna voglio.</i>
      </p>
      <span data-edition="ed1986" data-page="508"> </span>
      <p>
      ...
      <p>
        The keeper of the shelter in the middle of this <i>tête-à-tête</i> put a
        ...
        the honours by surreptitiously 
        <span data-edition="ed1939" data-page="437"> </span>
        pushing the cup of what was temporarily
      ...
      <span data-edition="ed1961" data-page="622"> </span>
      <p>
      ...
      <span data-edition="ed1922" data-page="578"> </span><span data-edition="ed1932" data-page="532"> </span>
      <p>
      ...
      <span data-edition="ed1986" data-page="509"> </span>
      <p>
      ...
      <span data-edition="ed1961" data-page="623"> </span>
      <p>
        <i>—{" "}Buffalo Bill shoots to kill, <br/>
        {" "}{" "}{" "}{" "}Never missed nor he never will.</i>
      </p>
      <p>
      ...
      <span data-edition="ed1939" data-page="438"> </span>
      <p>
        ...
        toured the wide world with <button className="bg-gray-300 bg-center bg-cover hover:bg-green-300" onClick={() => openNote("040066bonethemyoung")}>Hengler's Royal Circus</button>. I seen him do that in
        Stockholm.
      </p>
      <p>
      ...
      <span data-edition="ed1922" data-page="579"> </span>
      <p>
        —{" "}Queenstown harbour, Stephen replied.
      </p>
      <span data-edition="ed1932" data-page="533"> </span>
      <p>
        —{" "}That's right, the sailor said. <button className="bg-gray-300 bg-center bg-cover hover:bg-green-300" onClick={() => openNote("170019localities")}>Fort Camden and Fort Carlisle.</button> That's
      ...
      <p>
        ...
        Enoch Arden and Rip van Winkle and <button className="bg-gray-300 bg-center bg-cover hover:bg-green-300" onClick={() => openNote("160012caocoleary")}>does anybody hereabouts remember Caoc
        O'Leary, a favourite and most trying declamation piece</button> by the way of
        <button className="bg-gray-300 bg-center bg-cover hover:bg-green-300" onClick={() => openNote("160011johncasey")}>poor John Casey</button> and a bit of perfect poetry in its own small way.
        ...
        her knee, <i>post mortem</i> child. <span data-edition="ed1986" data-page="510"> </span>With a high ro! and a randy ro! and my
        galloping tearing <span data-edition="ed1961" data-page="624"> </span>tandy, O! Bow to the inevitable. Grin and bear it. I
      ...
      <p>
        —{" "}We come up this morning eleven o'clock. <button className="bg-gray-300 bg-center bg-cover hover:bg-green-300" onClick={() => openNote("030071threemaster")}>The threemaster <i>Rosevean</i>
        from Bridgwater with bricks.</button> I shipped to get over. Paid off this
      ...
      <span data-edition="ed1922" data-page="580"> </span><span data-edition="ed1932" data-page="534"> </span>
      <p>
      ...
      <p>
        ...
        I seen icebergs plenty, <button className="bg-gray-300 bg-center bg-cover hover:bg-green-300" onClick={() => openNote("160006icebergs")}>growlers</button>. I was in Stockholm and the Black 
      ...
      <p>
        ...
        printed matter on it stated: <i>Choza de Indios. Beni, Bolivia.</i>
      </p>
      <p>
        All focussed their attention at the scene exhibited, a group of savage
        women in striped loincloths, squatted, blinking, suckling, <span data-edition="ed1961" data-page="625"> </span>frowning,
      ...
      <p>
        ...
        children. See them sitting there stark ballocknaked eating a dead horse's liver
        raw.
      </p>
      <span data-edition="ed1986" data-page="511"> </span>
      <p>
      ...
      <p>
        ...
        as follows: <i>Tarjeta Postal, Señor A Boudin, Galeria Becche, Santiago,
        ...
        Lazarillo-Don Cesar de Bazan incident 
        <span data-edition="ed1922" data-page="581"> </span>
        depicted in <i>Maritana</i> on which
        occasion the <span data-edition="ed1932" data-page="535"> </span>former's ball passed through the latter's hat) having
        ...
        suspicions of our friend's <i>bona fides</i>, nevertheless it reminded him in
        a way of a longcherished plan he meant to one day realise some Wednesday
        or Saturday of travelling to London <i>via</i> long sea not to say that he had
        ...
        <button className="bg-gray-300 bg-center bg-cover hover:bg-green-300" onClick={() => openNote("060034martincunningham")}>Martin Cunningham</button> frequently said he would work a pass through Egan but
        ...
        <button className="bg-gray-300 bg-center bg-cover hover:bg-green-300" onClick={() => openNote("010126mullingar")}>Mullingar</button> where he figured on going was five and six there and back.
        ...
        a chap whose liver was
        out of order, seeing the different places along the route, Plymouth,
        <span data-edition="ed1961" data-page="626"> </span>Falmouth, Southampton and so on, culminating in an instructive tour of
        ...
        <button className="bg-gray-300 bg-center bg-cover hover:bg-green-300" onClick={() => openNote("180002margate")}>Margate with mixed bathing</button> and firstrate hydros and spas, Eastbourne,
        ...
        lady as a sort of counterblast to the Elster Grimes and <span data-edition="ed1986" data-page="512"> </span>Moody-Manners,
      ...
      <span data-edition="ed1922" data-page="582"> </span>
      <p>
        Also, without being actually
        positive, it struck him a great field was to <span data-edition="ed1932" data-page="536"> </span>be opened up in the line
        of opening up new routes to keep pace with the times <i>apropos</i> of the
        Fishguard-Rosslare route which, it was mooted, was once more on the
        <i>tapis</i> in the circumlocution departments with the usual quantity of red
      ...
      <p>
        ...
        months of it and merited a radical change of <i>venue</i> after the grind
        ...
        a steam tram, but also <button className="bg-gray-300 bg-center bg-cover hover:bg-green-300" onClick={() => openNote("060005churchyard")}>farther away from the madding crowd</button> in <button className="bg-gray-300 bg-center bg-cover hover:bg-green-300" onClick={() => openNote("050025botanicgardens")}>Wicklow,
        rightly termed the garden of Ireland</button>, an ideal neighbourhood for elderly
        ...
        associations and otherwise, <button className="bg-gray-300 bg-center bg-cover hover:bg-green-300" onClick={() => openNote("030058pretenders")}>Silken Thomas</button>, Grace O'Malley, George IV,
        ...
        of an hour's <button className="bg-gray-300 bg-center bg-cover hover:bg-green-300" onClick={() => openNote("070006nelsonspillar")}>run from the
        pillar</button>. Because of course uptodate tourist travelling was as yet merely
      ...
      <p>
        ...
        <span data-edition="ed1932" data-page="537"> </span><button className="bg-gray-300 bg-center bg-cover hover:bg-green-300" onClick={() => openNote("160008littlepills")}>little pills like putty and he put them in the water and they opened and
        every pill</button> <span data-edition="ed1986" data-page="513"> </span><button className="bg-gray-300 bg-center bg-cover hover:bg-green-300" onClick={() => openNote("160008littlepills")}>was something different. One was a ship, another was a house,
        another was a flower.</button> Cooks rats in your soup, he appetisingly added,
        the chinks does.
      </p>
      <p>
      ...
      <p>
        ...
        meet your God</i>, says he. Chuk! It went into his back up to the butt.
      </p>
      <p>
        His heavy glance drowsily roaming about kind of defied their further
        questions even should they by any chance want <span data-edition="ed1961" data-page="628"> </span>to.  That's a good bit of steel, repeated he, 
        examining his formidable <i>stiletto</i>.
      </p>
      <p>
        After which harrowing <i>dénouement</i> sufficient to appal the stoutest he
      ...
      <p>
        At this remark, passed obviously in the spirit of <i>where ignorance
        is bliss</i>, Mr Bloom and Stephen, each in his own particular way, both
        ...
        <i>alias</i> the keeper, was drawing spurts of liquid
      ...
      <p>
        ...
        land troubles, when it took the civilised world 
        <span data-edition="ed1922" data-page="584"> </span>
        by storm, figuratively
        speaking, early in the eighties, eightyone to be correct, when he was
        just turned fifteen.
      </p>
      <span data-edition="ed1932" data-page="538"> </span>
      <p>
      ...
      <span data-edition="ed1939" data-page="442"> </span>
      <p>
        ...
        he <span data-edition="ed1986" data-page="514"> </span>failed to do so, <button className="bg-gray-300 bg-center bg-cover hover:bg-green-300" onClick={() => openNote("080022sawdust")}>simply letting spurt a jet of spew into the sawdust</button>,
        and shook his head with a sort of lazy scorn.
      </p>
      <p>
        —{" "}What year would that be about? Mr Bloom interpolated. Can you recall the
        boats?
      </p>
      <span data-edition="ed1961" data-page="629"> </span>
      <p>
        Our <i>soi-disant</i> sailor munched heavily awhile hungrily before
        answering:
      </p>
      <p>
        —{" "}I'm tired of <button className="bg-gray-300 bg-center bg-cover hover:bg-green-300" onClick={() => openNote("160006icebergs")}>all them rocks in the sea</button>, he said, and boats and ships.
      ...
      <p>
        ...
        what it meant, to <button className="bg-gray-300 bg-center bg-cover hover:bg-green-300" onClick={() => openNote("010107seasruler")}>rule the waves</button>. On more than one occasion—a dozen
        ...
        it and it at him, dreaming of <button className="bg-gray-300 bg-center bg-cover hover:bg-green-300" onClick={() => openNote("020010lycidas")}>fresh woods and pastures new as someone
        somewhere sings</button>. And it left him wondering why. Possibly he had tried to
        ...
        secret about it at all. Nevertheless, without going into the <i>minutiae</i>
        ...
        other, lifeboat Sunday was a very laudable institution to which the
        ...
        <span data-edition="ed1922" data-page="585"> </span>
        ...
        sometimes had a terrible time of it in the wintertime not forgetting <button className="bg-gray-300 bg-center bg-cover hover:bg-green-300" onClick={() => openNote("030013kishlightship")}>the
        Irish lights, Kish and others</button>, liable to capsize at any moment, rounding
        which he once with his daughter had experienced some remarkably choppy,
        not to say stormy, weather.
      </p>
      <p>
        —{" "}There was a fellow sailed with me in the <i>Rover</i>, the old seadog,
        ...
        me and he gave me an oilskin and that <span data-edition="ed1961" data-page="630"> </span>jackknife. I'm game for that job,
      ...
      <span data-edition="ed1986" data-page="515"> </span>
      <p>
      ...
      <span data-edition="ed1939" data-page="443"> </span>
      <p>
      ...
      <span data-edition="ed1922" data-page="586"> </span>
      <p>
        And in point of fact the young man named Antonio's livid face did
        <span data-edition="ed1932" data-page="540"> </span>actually look like forced smiling and the curious effect excited the
        unreserved admiration of everybody, including Skin-the-Goat, who this
        time stretched over.
      </p>
      <p>
        —{" "}Ay, <button className="bg-gray-300 bg-center bg-cover hover:bg-green-300" onClick={() => openNote("160006icebergs")}> ay, sighed</button> the sailor, looking down on his manly chest. He's gone
      ...
      <span data-edition="ed1961" data-page="631"> </span>
      <p>
      ...
      <p>
        ...
        direction of the questioner about the number. A Greek he was.
      </p>
      <p>
      ...
      <p>
        <i>—{" "}As bad as old Antonio, <br/>
        {" "}{" "}{" "}{" "}For he left me on my ownio.</i>
      </p>
      <span data-edition="ed1986" data-page="516"> </span>
      <p>
        ...
        lane, who knew the lady in the 
        <span data-edition="ed1939" data-page="444"> </span>
        brown costume does be with you (Mrs B.),
        and begged the chance of his washing. Also why washing, which seemed
        rather vague than not?
      </p>
      <p>
        Your washing. Still, candour compelled him to
        ...
        <button className="bg-gray-300 bg-center bg-cover hover:bg-green-300" onClick={() => openNote("020064telegraph")}><i>Evening Telegraph</i></button> he
      ...
      <span data-edition="ed1961" data-page="632"> </span>
      <p>
      ...
      <p>
        ...
        stop to <i>instanter</i> to say that women of that stamp (quite apart from
        any oldmaidish squeamishness on the subject), a necessary evil, were
        not licensed and medically inspected by the proper authorities, a thing
        he could truthfully state he, as a <i>paterfamilias</i>, was a stalwart
      ...
      <span data-edition="ed1986" data-page="517"> </span>
      <p>
        ...
        the convolutions of the grey matter. Otherwise we would never have <button className="bg-gray-300 bg-center bg-cover hover:bg-green-300" onClick={() => openNote("080011xrays")}>such
        inventions as X rays</button>, for instance. Do you?
      </p>
      <p>
      ...
      <span data-edition="ed1922" data-page="588"> </span>
      <p>
        Mr Bloom thoroughly acquiesced in the general gist of this <span data-edition="ed1961" data-page="633"> </span>though the
        mystical finesse involved was a bit out of his sublunary depth still
        <span data-edition="ed1932" data-page="542"> </span>he felt bound to enter a demurrer on the head of simple, promptly
        rejoining:
      </p>
      <span data-edition="ed1939" data-page="445"> </span>
      <p>
      ...
      <p>
        ...
        original point. I'm not so sure about that.
      ...
      <p>
        ...
        <span data-edition="ed1986" data-page="518"> </span>lucrative) work. To be sure it was a legitimate object and beyond yea or
        ...
        orders. On the other hand, he had a <span data-edition="ed1961" data-page="634"> </span>distinct and painful recollection
        they paid his wife, Madam Marion Tweedy who had been prominently
        associated with it at one time, a 
        <span data-edition="ed1922" data-page="589"> </span>
        very modest remuneration indeed for
        her pianoplaying. The idea, he was strongly <span data-edition="ed1932" data-page="543"> </span>inclined to believe, was
        to do good and net a profit, there being no competition to speak
        of. Sulphate of copper poison, SO<sub>4</sub> or something in some dried peas he
      ...
      <p>
        ...
        regular meals as the <i>sine qua non</i> for any kind of proper work, mental
      ...
      <p>
        ...
        knife. I can't look at the point of it. <button className="bg-gray-300 bg-center bg-cover hover:bg-green-300" onClick={() => openNote("020007juliuscaesar")}>It reminds me of Roman history.</button>
      </p>
      <p>
      ...
      <p>
        —{" "}Our mutual friend's stories are like himself, Mr Bloom, <i>apropos</i> of
      ...
      <p>
        He had been meantime taking stock of the individual in <span data-edition="ed1961" data-page="635"> </span>front of him and
        ...
        <span data-edition="ed1922" data-page="590"> </span>
        ...
        <span data-edition="ed1932" data-page="544"> </span>and had served <span data-edition="ed1986" data-page="519"> </span>his four or five goodlooking years in durance vile to say
        ...
        seas to draw the long bow about the schooner <i>Hesperus</i> and etcetera.
      ...
      <p>
        ...
        reminded him a bit of <button className="bg-gray-300 bg-center bg-cover hover:bg-green-300" onClick={() => openNote("060040gaietytheatre")}>Ludwig, <i>alias</i> Ledwidge, when he occupied
        the boards of the Gaiety when Michael Gunn was identified with the
        management</button> in <button className="bg-gray-300 bg-center bg-cover hover:bg-green-300" onClick={() => openNote("160009flyingdutchmen")}>the <i>Flying Dutchman</i>, a stupendous success, and his host
        ...
        fell a bit flat as also did trains</button>), there was nothing intrinsically
        ...
        Italy there near <button className="bg-gray-300 bg-center bg-cover hover:bg-green-300" onClick={() => openNote("050014thecoombe")}>the Coombe</button>, were sober thrifty hardworking fellows
      ...
      <p>
        ...
        <span data-edition="ed1922" data-page="591"> </span>
        that, impetuous as Old Nick, are given to taking the law into their own
        hands and give you your quietus doublequick with those poignards<span data-edition="ed1932" data-page="545"> </span> they
      ...
      <span data-edition="ed1986" data-page="520"> </span>
      <p>
        —{" "}The temperaments at the door, Stephen interposed with, were very
        passionate about ten shillings. <i>Roberto ruba roba sua.</i>
      </p>
      <p>
      ...
      <p>
        ...
        listener somewhere, we have the impetuosity of <button className="bg-gray-300 bg-center bg-cover hover:bg-green-300" onClick={() => openNote("160003isoscelestriangle")}>Dante and the isosceles
        triangle, Miss Portinari, he fell in love with and Leonardo and san
        Tommaso Mastino.</button>
      </p>
      <p>
        ...
        woman's natural beauty, no matter what you say. Rumpled stockings—it may be, possibly is, a foible of mine, but still it's a thing I simply
        hate to see.
      </p>
      <p>
        ...
        <button className="bg-gray-300 bg-center bg-cover hover:bg-green-300" onClick={() => openNote("160006icebergs")}> collisions with icebergs</button>, all that sort of thing. Shipahoy, of course,
      ...
      <p>
        ...
        verse of distinctive merit 
        <span data-edition="ed1922" data-page="592"> </span>
        on the topic for the <i>Irish Times</i>),
        ...
        case of the s. s. <i>Lady Cairns</i> of Swansea, run into by the <i>Mona,</i> <span data-edition="ed1932" data-page="546"> </span>which
        was on an opposite tack, in rather muggyish weather and lost with all
        hands on deck. No aid was given. Her master, the <i>Mona's</i>, said he
        was afraid his collision bulkhead would give way. She had no water, it
        appears, in her hold.
      </p>
      <span data-edition="ed1939" data-page="448"> </span>
      <p>
      ...
      <p>
        ...
        burning <span data-edition="ed1986" data-page="521"> </span>interior, saw him produce a bottle and uncork it, or unscrew, and,
        ...
        girders of <button className="bg-gray-300 bg-center bg-cover hover:bg-green-300" onClick={() => openNote("050006looplinebridge")}>the Loop line</button>, rather out of his depth, as of course it was all
        ...
        <span data-edition="ed1961" data-page="638"> </span>bilgewater some little time subsequently splashing on the ground where
        it apparently awoke a horse of the cabrank. 
      </p>
      <p>
        A hoof scooped anyway for
        ...
        and shuffled in his box before composing his limbs again in the arms
        <span data-edition="ed1922" data-page="593"> </span>
        of Morpheus. A truly amazing piece of hard times in its most virulent
        form on a fellow most respectably connected and familiarised with decent
        home comforts all his life who came in for a cool £100 a year
        at one time which of course the doublebarrelled ass proceeded to make
        general ducks and drakes of. And there he was at the <span data-edition="ed1932" data-page="547"> </span>end of his tether
      ...
      <p>
        There were wrecks and wrecks, the keeper said, who was evidently <i>au
        fait</i>.
      </p>
      <p>
      ...
      <p>
        ...
        time being in his <span data-edition="ed1961" data-page="639"> </span>fist while he did the drinking and making water jobs
        and found it a bit sour after the liquid fire in question. Anyhow in
        he rolled after his successful libation-<i>cum</i>-potation, introducing an
        atmosphere of drink into the <i>soirée</i>, boisterously trolling, like a
      ...
      <p>
        ...
        <span data-edition="ed1922" data-page="594"> </span>
        scene and, regaining his seat, he sank rather than sat heavily on the form
        provided. 
      </p>
      <p>
        Skin-the-Goat, assuming he was he, evidently with an axe to
        ...
        the face of God's <span data-edition="ed1932" data-page="548"> </span>earth, far and away superior to England, with coal in
        ...
        thing in Irish soil, he stated, and there was <button className="bg-gray-300 bg-center bg-cover hover:bg-green-300" onClick={() => openNote("100002tobacco")}>colonel Everard down
        there in Navan growing tobacco</button>. Where would you find anywhere the like
      ...
      <span data-edition="ed1961" data-page="640"> </span>
      <p>
        Silence all round marked the termination of his <i>finale</i>. The impervious
      ...
      <span data-edition="ed1939" data-page="450"> </span>
      <span data-edition="ed1986" data-page="523"> </span>
      <p>
      ...
      <p>
        ...
        peasant. He's <button className="bg-gray-300 bg-center bg-cover hover:bg-green-300" onClick={() => openNote("010058bloodyswindle")}>the backbone of our empire</button>. You know Jem Mullins?
      </p>
      <p>
      ...
      <span data-edition="ed1932" data-page="549"> </span>
      <p>
        ...
        whores and chummies, to put it in common parlance, reminded him <button className="bg-gray-300 bg-center bg-cover hover:bg-green-300" onClick={() => openNote("010058bloodyswindle")}>Irish
        soldiers had as often fought for England as against her, more so, in
        fact</button>. And now, why? So the scene between the pair of them, the licensee
        ...
        prearranged, as the <span data-edition="ed1961" data-page="641"> </span>lookeron, a student of the human soul, if anything,
        ...
        forward and <button className="bg-gray-300 bg-center bg-cover hover:bg-green-300" onClick={() => openNote("040089denzille")}>turning queen's evidence—or king's now—like Denis or Peter
        Carey, an idea he utterly repudiated.</button> Quite apart from that, he disliked
        ...
        <span data-edition="ed1922" data-page="596"> </span>
        kind of admiration for a man who
        ...
        any such thing, off the <span data-edition="ed1986" data-page="524"> </span>same bat as those love vendettas of the south—have her or swing for her—when 
        the husband frequently, after some words
        ...
        his adored one as a result of an alternative postnuptial <i>liaison</i>
        ...
        <button className="bg-gray-300 bg-center bg-cover hover:bg-green-300" onClick={() => openNote("050013jauntingcar")}>the car</button> for the actual
        ...
        naturally or on the scaffold high. Like actresses, always farewell—positively last performance—then come up smiling again. Generous to a
        ...
        the others, he had heard not so long before the same identical lingo, as he
      ...
      <p>
        ...
        family, like me, though <button className="bg-gray-300 bg-center bg-cover hover:bg-green-300" onClick={() => openNote("040083hewasajew")}>in reality I'm not</button>. That was one for him. A soft
      ...
      <p>
        —{" "}<i>Ex quibus</i>, Stephen mumbled in a noncommittal accent, their two or
        four eyes conversing, <i>Christus</i> or Bloom his name is or, after all, any
        other, <i>secundum carnem</i>.
      </p>
      <p>
        —{" "}Of course, Mr Bloom proceeded to stipulate, you must look at both sides
        of the question. It is hard to lay down any hard and fast rules as to right 
        <span data-edition="ed1922" data-page="597"> </span>
        ...
        people because they live round the corner and speak another vernacular, so to speak.
      </p>
      <span data-edition="ed1932" data-page="551"> </span>
      <p>
        —{" "}Memorable bloody bridge battle and seven minutes' war, Stephen
        assented, between Skinner's alley and Ormond market.
      </p>
      <span data-edition="ed1986" data-page="525"> </span>
      <p>
        —{" "}Yes, Mr Bloom thoroughly agreed, entirely endorsing the remark, that
        was overwhelmingly right and the whole world was overwhelmingly full of that sort of
        thing.
      </p>
      <p>
      ...
      <p>
        ...
        bad blood—bump of combativeness or gland of some kind,
        erroneously supposed to be about a punctilio of honour and a flag—were very largely a question of the money question which was at the back of
      ...
      <span data-edition="ed1939" data-page="452"> </span>
      <p>
        —{" "}Jews, he softly imparted in an aside in Stephen's ear, are <span data-edition="ed1961" data-page="643"> </span>accused of
        ...
        imported them. Why? Because they are imbued with <button className="bg-gray-300 bg-center bg-cover hover:bg-green-300" onClick={() => openNote("160001priestpoverty")}>the proper spirit. They
        ...
        spells poverty.</button> Spain again, you saw in the war, compared with goahead
        America. Turks. It's in the dogma. Because if they didn't believe they'd
        go straight to heaven when they die they'd try to live better—at least, so I think. That's the juggle on which the p.p's raise the wind on false
        ...
        <span data-edition="ed1922" data-page="598"> </span>
        ...
        in the neighbourhood of £300 per annum. That's the vital issue
        ...
        worth. I call that patriotism. <i>Ubi patria</i>, as we learned a smattering
        of in our classical days in <i>Alma Mater, vita bene</i>. Where you can live
      ...
      <p>
        ...
        crabs about  <button className="bg-gray-300 bg-center bg-cover hover:bg-green-300" onClick={() => openNote("030099ringsend")}> Ringsend</button> in the morning, burrowing quickly into all colours
      ...
      <span data-edition="ed1986" data-page="526"> </span>
      <p>
        ...
        the thing. <button className="bg-gray-300 bg-center bg-cover hover:bg-green-300" onClick={() => openNote("160004newspapers")}>Writing for the newspapers</button> which is the readiest channel
      ...
      <p>
        ...
        be important because I belong to the <i>faubourg Saint Patrice</i> called
        Ireland for short.
      </p>
      <p>
      ...
      <span data-edition="ed1939" data-page="453"> </span>
      <p>
        —{" "}We can't change the country. Let us change the subject.
      </p>
      <span data-edition="ed1922" data-page="599"> </span>
      <p>
        ...
        foreign to his sober state. Probably the home life, to which Mr Bloom attached
        ...
        of some consternation remembering he had just come back <span data-edition="ed1932" data-page="553"> </span>from Paris,
        ...
        there was the case of O'Callaghan, for one, the half crazy faddist,
        ...
        public a suit of brown paper (a fact). And then the usual <i>dénouement</i>
        ...
        to a blind <span data-edition="ed1961" data-page="645"> </span>horse from John Mallon of Lower Castle Yard, so as not to
        ...
        deaf ear to, <span data-edition="ed1986" data-page="527"> </span>Antonio and so forth, jockeys and esthetes and the tattoo
        ...
        should, and every 
        <span data-edition="ed1922" data-page="600"> </span>
        welltailored man must, trying to make the gap wider
      ...
      <p>
        ...
        bad, <span data-edition="ed1932" data-page="554"> </span>having, in fact, let himself in for it. Still, to cultivate the
        ...
        <span data-edition="ed1939" data-page="454"> </span>
        stimulation
        ...
        whole galaxy of events, <button className="bg-gray-300 bg-center bg-cover hover:bg-green-300" onClick={() => openNote("070021putusall")}>all went to make up a miniature cameo of the
        world we live in</button>, especially as the lives of the submerged tenth, viz.,
        ...
        with anything approaching <button className="bg-gray-300 bg-center bg-cover hover:bg-green-300" onClick={() => openNote("040019titbits")}>the same luck as Mr Philip Beaufoy</button> if taken
        down in writing. <button className="bg-gray-300 bg-center bg-cover hover:bg-green-300" onClick={() => openNote("040030leopoldbloom")}>Suppose he were to pen something out of the common
        groove</button> (as he fully intended doing) at the rate of one guinea per
        column, <i>My Experiences</i>, let us say, <i>in a Cabman's Shelter</i>.
      </p>
      <p>
        <button className="bg-gray-300 bg-center bg-cover hover:bg-green-300" onClick={() => openNote("020064telegraph")}>The pink edition, extra sporting, of the <i>Telegraph</i>, tell a graphic lie</button>,
        ...
        allembracing <button className="bg-gray-300 bg-center bg-cover hover:bg-green-300" onClick={() => openNote("040077ourfather")}>give us this day our daily press</button>. First he got a bit of a
        ...
        odds. <button className="bg-gray-300 bg-center bg-cover hover:bg-green-300" onClick={() => openNote("100008generalslocum")}>New York disaster, thousand lives lost.</button> <button className="bg-gray-300 bg-center bg-cover hover:bg-green-300" onClick={() => openNote("020054footandmouth")}>Foot and Mouth.</button> Funeral of
      ...
      <p>
        ...
        Patrick Dignam were removed from his residence, <button className="bg-gray-300 bg-center bg-cover hover:bg-green-300" onClick={() => openNote("060019theavenue")}>n° 9 Newbridge Avenue,
        Sandymount</button>, for interment in Glasnevin. The deceased gentleman was a
        ...
        deceased were present, were carried out</i> (certainly Hynes wrote it with
        a nudge from Corny) <i>by Messrs. H. J. O'Neill &amp; Son, 164 North Strand
        ...
        Monks the dayfather about Keyes's ad), <i><button className="bg-gray-300 bg-center bg-cover hover:bg-green-300" onClick={() => openNote("050037tomkernan")}>Thomas Kernan</button>, Simon Dedalus,
      ...
      <p>
        ...
        their total absence (to say nothing of M'Intosh), <button className="bg-gray-300 bg-center bg-cover hover:bg-green-300" onClick={() => openNote("040082highgradeha")}> L. Boom pointed it
        out to his companion B. A.</button>, engaged in stifling another yawn, half
      ...
      <p>
        ...
        be no possible 
        <span data-edition="ed1939" data-page="455"> </span>
        connection) overjoyed to set his mind at rest and a bit
      ...
      <p>
        ...
        <span data-edition="ed1922" data-page="602"> </span>
        trained by Braine so that Lenehan's version of the business was all pure
        buncombe. Secured the verdict cleverly by a length. 1,000 sovs. <span data-edition="ed1986" data-page="529"> </span>with
        ...
        II</i>. Different ways of bringing off a coup. Lovemaking damages. Though
      ...
      <span data-edition="ed1932" data-page="556"> </span>
      <p>
        —{" "}Who? the other, whose hand by the way was hurt, said.
      </p>
      <p>
        —{" "}One morning you would open the paper, the cabman affirmed, and read:
        <i>Return of Parnell</i>. He bet them what they <span data-edition="ed1961" data-page="648"> </span>liked. A <button className="bg-gray-300 bg-center bg-cover hover:bg-green-300" onClick={() => openNote("030118royaldublins")}>Dublin fusilier</button> was
      ...
      <p>
        ...
        were decidedly of the <i>Alice, where art thou</i> order even prior to his
        starting to go under several aliases such as Fox and Stewart, so the
        <span data-edition="ed1922" data-page="603"> </span>
        remark which emanated from friend cabby might be within the bounds of
        possibility. Naturally 
        <span data-edition="ed1939" data-page="456"> </span>
        then, it would prey on his mind as a born leader
        ...
        far between. It certainly pointed a moral, the idol with feet of clay. And then seventytwo of his trusty henchmen rounding on him with mutual
        mudslinging. And the identical same with murderers. You had <span data-edition="ed1986" data-page="530"> </span>to come
        back—that haunting sense kind of drew you—to 
        show the understudy in
        the title <i>rôle</i> how to. He <span data-edition="ed1932" data-page="557"> </span>saw him once on the auspicious occasion
        when they broke up <span data-edition="ed1961" data-page="649"> </span>the type in the <i>Insuppressible</i> or was it <i>United
        Ireland</i>, a privilege he keenly appreciated, and, in point of fact,
        handed him his silk hat when it was knocked off and he said <i>Thank you</i>,
        ...
        Roger Charles Tichborne, <i>Bella</i> was the boat's name to the best of his
        ...
        himself with, <i>Excuse me, my name is So and So</i> or some such commonplace
        remark. A more prudent course, Bloom said to the not over effusive,
      ...
      <p>
        —{" "}Fine lump of a woman, all the same, the <i>soi-disant</i> townclerk Henry
        Campbell remarked, and plenty of her. I seen her picture in a barber's. The husband was a captain or an
        officer.
      </p>
      <p>
      ...
      <p>
        ...
        amount of laughter among his <i>entourage</i>. As regards Bloom, he, without
        the faintest suspicion of a smile, merely gazed in the direction of
        the door and reflected 
        <span data-edition="ed1922" data-page="604"> </span>
        upon the historic story which had aroused
        ...
        like the <span data-edition="ed1961" data-page="650"> </span>sensational extent that it subsequently blossomed into. Since
        their names were coupled, though, since he was her declared favourite,
        <span data-edition="ed1932" data-page="558"> </span>where was the particular necessity to proclaim it to the rank and file
        ...
        swearing to having witnessed him on such 
        <span data-edition="ed1939" data-page="457"> </span>
        and such a particular date in
        the act of scrambling out of an upstairs apartment with <span data-edition="ed1986" data-page="531"> </span>the assistance
        ...
        usual everyday <i>farewell, my gallant captain</i> kind of an individual in
        ...
        very effectually cooked his matrimonial goose, thereby heaping 
        <span data-edition="ed1922" data-page="605"> </span>
        coals of
        fire on his head, much in the same way as the fabled ass's kick. Looking
        back now in <button className="bg-gray-300 bg-center bg-cover hover:bg-green-300" onClick={() => openNote("060030retrospective")}>a retrospective kind of arrangement</button>, all seemed a kind of
        ...
        with the times. Why, as he reflected, <button className="bg-gray-300 bg-center bg-cover hover:bg-green-300" onClick={() => openNote("030015irishtown")}>Irishtown strand</button>, a locality he
        ...
        <span data-edition="ed1932" data-page="559"> </span>wouldn't do things by halves, passionate abandon of the south, casting
        every shred of decency to the winds.
      </p>
      <p>
        —{" "}Just bears out what I was saying, he with glowing bosom said to
        Stephen. And, if I don't greatly mistake, she
        was Spanish too.
      </p>
      <p>
      ...
      <p>
        ...
        by the by of that <button className="bg-gray-300 bg-center bg-cover hover:bg-green-300" onClick={() => openNote("040043capelstreet")}>Capel street library</button> book out of date, he took out his
      ...
      <p>
        ...
        was in the full 
        <span data-edition="ed1939" data-page="458"> </span>
        bloom of womanhood, in evening dress cut ostentatiously
        ...
        near, ostensibly with gravity, a piano, on the rest of which was <i>In Old
        Madrid</i>, a ballad, pretty in its way, which was then all the vogue. Her
      ...
      <p>
        —{" "}Mrs Bloom, my wife the <i>prima donna</i>, Madam Marion Tweedy, Bloom
        indicated. Taken a few years since. In or about '96. Very like
        her then.
      </p>
      <span data-edition="ed1922" data-page="606"> </span>
      <p>
        ...
        as a singer having even made <span data-edition="ed1961" data-page="652"> </span>her bow to the public when her years
        ...
        the... He dwelt, <span data-edition="ed1932" data-page="560"> </span>being a bit of an artist in his spare time, on the female
        ...
        Puritanism. It does though, Saint Joseph's sovereign... whereas no photo 
      ...
      <p>
        ...
        by opulent curves, none the worse for wear, <span data-edition="ed1986" data-page="533"> </span>however, and looked away
        ...
        <i>embonpoint</i>. In fact, the slight soiling was only an added charm, like
        ...
        <button className="bg-gray-300 bg-center bg-cover hover:bg-green-300" onClick={() => openNote("040021ruby")}>the book about Ruby</button> with <button className="bg-gray-300 bg-center bg-cover hover:bg-green-300" onClick={() => openNote("030087pastlife")}>met him pike hoses</button> (<i>sic</i>) in it which must
      ...
      <p>
        ...
        <i>distingué</i>, and impulsive into the bargain, far and away the pick of the
        bunch, though you wouldn't think he had it in him... yet you would. Besides
        he said the 
        <span data-edition="ed1922" data-page="607"> </span>
        picture was handsome which, say what you like, it was, though
        at the moment <span data-edition="ed1961" data-page="653"> </span>she was distinctly stouter. And why not? An awful lot of
        makebelieve went on about that sort of thing involving a lifelong slur
        with the usual splash page of letterpress about the same 
        <span data-edition="ed1939" data-page="459"> </span>
        old matrimonial
        ...
        was told in court with letters containing the habitual mushy <span data-edition="ed1932" data-page="561"> </span>and
        ...
        intimate. Then the decree <i>nisi</i> and the King's proctor tries to show
        cause why and, he failing to quash it, <i>nisi</i> was made absolute. But as
        ...
        the party wronged in due course. He, Bloom, enjoyed the distinction of being
        close to Erin's uncrowned king in the flesh when the thing occurred on
        the historic <i>fracas</i> when the fallen leader's—who notoriously stuck to
        his guns to the last drop even when clothed in the mantle of adultery—(leader's) trusty henchmen to the number of ten or a dozen or
        ...
        minor <span data-edition="ed1986" data-page="534"> </span>injury from a nasty prod of some chap's elbow in the crowd that
        of course congregated lodging some place about the pit of the stomach,
        fortunately not of a grave character. His hat (Parnell's) was
        inadvertently knocked off and, as a matter of strict history, Bloom was
        the man who picked it up in the <span data-edition="ed1961" data-page="654"> </span>crush after witnessing the occurrence
        meaning to return it to him (and return it to him he did with the utmost
        <span data-edition="ed1922" data-page="608"> </span>
        ...
        the donor and thanked him with perfect <i>aplomb</i>, saying: <i>Thank you,
        sir</i>, though in a very different tone of voice from the ornament of the
        legal profession whose headgear Bloom also set to rights earlier in the
        course of the day, history repeating itself with <span data-edition="ed1932" data-page="562"> </span>a difference, after
      ...
      <p>
        ...
        the usual boy Jones, who happened to come across them 
        <span data-edition="ed1939" data-page="460"> </span>
        at the crucial
        ...
        on another, the cause of many <i>liaisons</i> between still attractive
        married women getting on for fair and forty <span data-edition="ed1961" data-page="655"> </span>and younger men, no doubt as
      ...
      <p>
        ...
        his <span data-edition="ed1986" data-page="535"> </span>lifetime. In 
        <span data-edition="ed1922" data-page="609"> </span>
        the nature of single blessedness he would one day take
        ...
        brought him down to <button className="bg-gray-300 bg-center bg-cover hover:bg-green-300" onClick={() => openNote("030015irishtown")}>Irishtown</button> so early in the morning), as to whether he
        ...
        tri-weekly with the orthodox preliminary canter of <span data-edition="ed1932" data-page="563"> </span>complimentpaying and
        ...
        ought to eat, were it only an eggflip made on unadulterated maternal
      ...
      <p>
        —{" "}<button className="bg-gray-300 bg-center bg-cover hover:bg-green-300" onClick={() => openNote("010138eatenall")}>The day before yesterday</button>, Stephen said, improving on himself.
      </p>
      <p>
        ...
        some score of years previously when he had been a <i>quasi</i> aspirant to
        ...
        people's mind though, it goes <span data-edition="ed1961" data-page="656"> </span>without 
        <span data-edition="ed1939" data-page="461"> </span>
        saying, not contributing a copper
        ...
        resented the innuendo put upon him in so barefaced a fashion 
        <span data-edition="ed1922" data-page="610"> </span>
        at the gathering of the clans in Barney Kiernan's so that he,
        ...
        and the misery and suffering <span data-edition="ed1986" data-page="536"> </span>it entailed as a foregone conclusion on
        fine young fellows, chiefly, destruction of the fittest, in a word.
      </p>
      <span data-edition="ed1932" data-page="564"> </span>
      <p>
        Anyhow, upon weighing the pros and cons, getting on for one as it
        ...
        His initial impression was that he was a bit standoffish or not over
        ...
        eschewing for the nonce hidebound precedent, a cup of <button className="bg-gray-300 bg-center bg-cover hover:bg-green-300" onClick={() => openNote("170006eppscocoa")}>Epps's cocoa</button> and
        ...
        and it was highly likely some sponger's bawdyhouse of retired beauties off Sheriff street lower would be the best clue
        ...
        betweenwhiles with rough and tumble gusto to the 
        <span data-edition="ed1922" data-page="611"> </span>
        accompaniment of large
        potations of potheen and the usual blarney about himself for as to who
        he in reality was let XX equal my right name and address, as Mr Algebra
        remarks <i>passim</i>. At the same time he inwardly chuckled over his
        repartee to the blood and ouns champion about his god being a jew.
        People could 
        <span data-edition="ed1939" data-page="462"> </span>
        ...
        came from <button className="bg-gray-300 bg-center bg-cover hover:bg-green-300" onClick={() => openNote("040046countyleitrim")}>Carrick-on-Shannon</button> or somewhere about in the county Sligo.
      </p>
      <p>
        ...
        vicinity. You can't drink that stuff. Wait, I'll just
        pay this lot.
      </p>
      <span data-edition="ed1986" data-page="537"> </span>
      <p>
      ...
      <p>
        ...
        with theatres, turning money away, duets in Italian
        ...
        housetops <span data-edition="ed1961" data-page="658"> </span>about it and a slice of luck. An opening was all was wanted.
      ...
      <span data-edition="ed1922" data-page="612"> </span>
      <p>
      ...
      <p>
        ...
        Sand in the Red Sea done that. One time I could read a book in the <span data-edition="ed1932" data-page="566"> </span>dark,
        manner of speaking. <i>The Arabian Nights Entertainment</i> was my favourite
        and <i>Red as a Rose is She.</i>
      </p>
      <p>
        Thereupon he pawed the journal open and pored upon Lord only knows what,
        <button className="bg-gray-300 bg-center bg-cover hover:bg-green-300" onClick={() => openNote("030069founddrowned")}>found drowned</button> or <button className="bg-gray-300 bg-center bg-cover hover:bg-green-300" onClick={() => openNote("050041cricket")}>the exploits of King Willow, Iremonger having made a
        hundred and something second wicket not out for Notts</button>, during which
      ...
      <span data-edition="ed1939" data-page="463"> </span>
      <span data-edition="ed1986" data-page="538"> </span>
      <p>
        ...
        the occasion, taken the wise precaution <span data-edition="ed1961" data-page="659"> </span>to unobtrusively motion to mine
      ...
      <p>
        —{" "}Come, he counselled, to close the <i>séance</i>.
      </p>
      <p>
        Seeing that the ruse worked and the coast was clear, they left the
        shelter or shanty together and the <i>élite</i> society of oilskin and
        company whom nothing short of an earthquake would move out of their
        <i>dolce far niente</i>. Stephen, who confessed to still feeling poorly and
        fagged out, paused at the, for a moment... the door to...
      </p>
      <p>
      ...
      <span data-edition="ed1922" data-page="613"> </span>
      <p>
        To which impromptu the neverfailing
      ...
      <p>
        ...
        <span data-edition="ed1932" data-page="567"> </span>a moment. The only thing is to walk then you'll feel a different man. It's not far. Lean on me.
      </p>
      <p>
      ...
      <p>
        —{" "}Yes, Stephen said uncertainly, because he thought he <button className="bg-gray-300 bg-center bg-cover hover:bg-green-300" onClick={() => openNote("010152linkedarm")}>felt a strange
        kind of flesh of a different man approach him</button>, sinewless and wobbly and
        all that.
      </p>
      <p>
        ...
        of  <button className="bg-gray-300 bg-center bg-cover hover:bg-green-300" onClick={() => openNote("020010lycidas")}>fresh fields and pastures new</button>. And <i>apropos</i> of coffin of stones, the
      ...
      <p>
        ...
        tracks arm in arm across <button className="bg-gray-300 bg-center bg-cover hover:bg-green-300" onClick={() => openNote("160007shipofthestreet")}>Beresford place</button>. <button className="bg-gray-300 bg-center bg-cover hover:bg-green-300" onClick={() => openNote("160009flyingdutchmen")}>Wagnerian music, though
        confessedly</button> <span data-edition="ed1986" data-page="539"> </span><button className="bg-gray-300 bg-center bg-cover hover:bg-green-300" onClick={() => openNote("160009flyingdutchmen")}>grand in its way, was a bit too heavy for Bloom and hard to
        follow at the first go-off</button> but the music of Mercadante's <i>Huguenots</i>,
        ...
        those Moody and Sankey hymns or <i>Bid me to live and I will live
        thy protestant to be</i>. He also yielded to none in his admiration of 
        <span data-edition="ed1939" data-page="464"> </span>
        Rossini's <i>Stabat Mater</i>, a work simply abounding in immortal numbers,
        ...
        shade, in the <button className="bg-gray-300 bg-center bg-cover hover:bg-green-300" onClick={() => openNote("010008jesuit")}>jesuit</button> fathers' <button className="bg-gray-300 bg-center bg-cover hover:bg-green-300" onClick={() => openNote("100010xavier")}>church
        in upper Gardiner street</button>, the sacred edifice being thronged to the
        ...
        favourites, he mentioned <i>par excellence</i> Lionel's air in <span data-edition="ed1932" data-page="568"> </span><i>Martha,
        M'appari</i>, which, curiously enough, he heard, or overheard, to be
        ...
        reply to a politely put query, said he didn't but launched
        ...
        herbalist, who <i>anno ludendo hausi, Doulandus</i>, an instrument he was
        contemplating purchasing from Mr Arnold Dolmetsch, whom Bloom did not quite
        recall, though the name certainly sounded familiar, for <span data-edition="ed1961" data-page="661"> </span>sixtyfive guineas
        and Farnaby and son with their <i>dux</i> and <i>comes</i> conceits and Byrd
      ...
      <p>
        By the chains, the horse <button className="bg-gray-300 bg-center bg-cover hover:bg-green-300" onClick={() => openNote("160007shipofthestreet")}>slowly swerved</button> to turn, which perceiving, Bloom,
        who was <button className="bg-gray-300 bg-center bg-cover hover:bg-green-300" onClick={() => openNote("160006icebergs")}> keeping a sharp lookout</button> as usual, plucked the other's sleeve
        gently, jocosely remarking:
      </p>
      <p>
        —{" "}Our lives are in peril tonight. Beware of <button className="bg-gray-300 bg-center bg-cover hover:bg-green-300" onClick={() => openNote("160007shipofthestreet")}>the steamroller</button>.
      </p>
      ...
      <p>
        ...
        near, so that <button className="bg-gray-300 bg-center bg-cover hover:bg-green-300" onClick={() => openNote("160007shipofthestreet")}>it seemed new</button>, a different grouping of bones and even flesh,
        ...
        wisely reflected, you could scarcely be prepared for <button className="bg-gray-300 bg-center bg-cover hover:bg-green-300" onClick={() => openNote("160006icebergs")}>every emergency
        that might crop up</button>. He was just a big nervous foolish noodly kind of a
        horse, without a second care in the world. But even a dog, he reflected,
        take that mongrel in Barney Kiernan's, of the same size, would be <button className="bg-gray-300 bg-center bg-cover hover:bg-green-300" onClick={() => openNote("160007shipofthestreet")}>a holy
        horror</button> to face. But it was no animal's fault in particular if he was
        ...
        harpoon hairpin, alligator, tickle the small of his <span data-edition="ed1932" data-page="569"> </span>back and he sees the
        joke; 
        ...
        distracted from Stephen's words, while <button className="bg-gray-300 bg-center bg-cover hover:bg-green-300" onClick={() => openNote("160007shipofthestreet")}>the ship of the street was
        manoeuvring</button> and Stephen went on about the highly interesting old...
      </p>
      <p>
        —{" "}What's this I was saying? Ah, yes! My wife, he intimated, plunging
        <i>in medias res</i>, would have the greatest of pleasure <span data-edition="ed1961" data-page="662"> </span>in making your
      ...
      <p>
        ...
        image of his mother, which was not quite the same as the usual
        blackguard type they unquestionably had an indubitable hankering after as
      ...
      <p>
        Exquisite variations he was now describing on an air <i>Youth here has
        End</i> by Jans Pieter Sweelinck, a Dutchman of Amsterdam where the frows
        come from. Even more he liked an old German song of <i>Johannes Jeep</i>
      ...
      <p><i>Von der Sirenen Listigkeit <br/>
        Tun die Poeten dichten.</i>
      </p>
      <p>
        These opening bars he sang and translated <i>extempore</i>. Bloom, nodding,
      ...
      <p>
        ...
        if properly 
        <span data-edition="ed1922" data-page="616"> </span>
        handled by some recognised authority on voice production
        ...
        its fortunate <span data-edition="ed1986" data-page="541"> </span>possessor in the near future an <i>entrée</i> into fashionable
        ...
        little thing <span data-edition="ed1932" data-page="570"> </span>like that could militate against you. It was in fact only a
        matter of months and he could easily foresee him participating in their
        musical and artistic <i>conversaziones</i> during <span data-edition="ed1961" data-page="663"> </span>the festivities of the
        ...
        be handed 
        <span data-edition="ed1939" data-page="466"> </span>
        a cheque at a muchneeded moment when every little helped.
        ...
        confiding public by Ivan St Austell and Hilton St Just and their <i>genus
        omne</i>. Yes, beyond a shadow of a doubt, he could with all the cards in
        ...
        upstairs, so to speak—a big <i>if</i>, however—
        with some impetus of the
        ...
        detract from the <span data-edition="ed1922" data-page="617"> </span>
        other by one iota as, being his own master, he would
      ...
      <p>
        ...
        prone to disparage, <span data-edition="ed1986" data-page="542"> </span>and <span data-edition="ed1961" data-page="664"> </span>even, to a slight extent, with some hilarious
        pretext, when not present, deprecate him, or whatever you like to call it,
        <span data-edition="ed1932" data-page="571"> </span>which, in Bloom's humble opinion, threw a nasty sidelight on that side of
      ...
      <p>
        Side by side Bloom, profiting by the <i>contretemps</i>, with Stephen passed
      ...
      <p>
        <i>Und alle Schiffe brücken.</i>
      </p>
      <p>
        The driver never said a word, good, bad or indifferent. He merely
        watched the two figures, as he sat on his lowbacked car, both black—one full, one lean—walk towards the railway bridge, <i>to be married by
        Father Maher</i>. As they walked they at times stopped and walked again
        continuing their <i>tête-à-tête</i> (which of course he was 
        utterly out of) about sirens, enemies of man's reason, mingled with a number of other
        ...
        far simply sat in his seat near the end of lower Gardiner street <i>and
        looked after their lowbacked car</i>.
      </p>
      <br/><br/><br/>
      <span data-edition="ed1922" data-page="618"> </span>
      <span data-edition="ed1939" data-page="467"> </span>
      <span data-edition="ed1961" data-page="665"> </span>
      <span data-edition="ed1932" data-page="572"> </span>
      <span data-edition="ed1986" data-page="543"> </span>		  	
    </div>
  )
}

export default Eumaeus;
