...
const OxenOfTheSun = ({openNote, currentNoteId}) => {
  return (
    <div>
      <p></p>
      <center><font size="+2">[14]</font></center>
      <br/>
      <Annotation annotationId="140032deshileamus" annotationSelect={() => openNote("140032deshileamus")} activeAnnotationId={currentNoteId}>Deshil Holles Eamus.</Annotation> Deshil <Annotation annotationId="140035holles" annotationSelect={() => openNote("140035holles")} activeAnnotationId={currentNoteId}>Holles</Annotation> Eamus. Deshil Holles Eamus.
      <p></p>
      <p>
        Send us <Annotation annotationId="140037brightone" annotationSelect={() => openNote("140037brightone")} activeAnnotationId={currentNoteId}>bright one, light one, Horhorn</Annotation>, quickening and wombfruit. Send
        us bright one, light one, Horhorn, quickening and wombfruit. Send us
        bright one, light one, Horhorn, quickening and wombfruit.
      </p>
      <p>
        <Annotation annotationId="140036hoopsaboyaboy" annotationSelect={() => openNote("140036hoopsaboyaboy")} activeAnnotationId={currentNoteId}>Hoopsa boyaboy hoopsa!</Annotation> Hoopsa boyaboy hoopsa! Hoopsa boyaboy hoopsa!
      </p>
      <p>
        <Annotation annotationId="140033universally" annotationSelect={() => openNote("140033universally")} activeAnnotationId={currentNoteId}>Universally that person's acumen is esteemed very little perceptive</Annotation>
        ...
        can contend against <Annotation annotationId="080028multiply" annotationSelect={() => openNote("080028multiply")} activeAnnotationId={currentNoteId}> the bounty of increase</Annotation> so it behoves every most just
      ...
      <p>
        <Annotation annotationId="140031historians" annotationSelect={() => openNote("140031historians")} activeAnnotationId={currentNoteId}>It is not why therefore we shall wonder if, as the best historians
      ...
      <p>
        <Annotation annotationId="140040beforeborn" annotationSelect={() => openNote("140040beforeborn")} activeAnnotationId={currentNoteId}>Before born bliss babe had. Within womb won he worship.</Annotation> Whatever in that
      ...
      <p>
        Some man that wayfaring was stood by housedoor at night's oncoming. <Annotation annotationId="020061wanderers" annotationSelect={() => openNote("020061wanderers")} activeAnnotationId={currentNoteId}>Of
      ...
      <p>
        Of that house <Annotation annotationId="140038drhorne" annotationSelect={() => openNote("140038drhorne")} activeAnnotationId={currentNoteId}>A. Horne</Annotation> is lord. <Annotation annotationId="140035holles" annotationSelect={() => openNote("140035holles")} activeAnnotationId={currentNoteId}>Seventy beds</Annotation> keeps he there teeming
        ...
        in ward sleepless. Smarts they still, sickness soothing: <Annotation annotationId="140035holles" annotationSelect={() => openNote("140035holles")} activeAnnotationId={currentNoteId}>in twelve moons
      ...
      <p>
        <Annotation annotationId="140030everyman" annotationSelect={() => openNote("140030everyman")} activeAnnotationId={currentNoteId}>Therefore, everyman, look to that last end that is thy death</Annotation> and the dust 
      ...
      <p>
        <Annotation annotationId="140029thecastle" annotationSelect={() => openNote("140029thecastle")} activeAnnotationId={currentNoteId}>And whiles they spake the door of the castle was opened</Annotation> and there nighed
        ...
        had had ado each with other in <Annotation annotationId="010068themater" annotationSelect={() => openNote("010068themater")} activeAnnotationId={currentNoteId}>the house of misericord</Annotation> where this
        learningknight lay by cause the traveller Leopold came there to be
        <span data-edition="ed1932" data-page="349"> </span>healed for <Annotation annotationId="040040bluebottle" annotationSelect={() => openNote("040040bluebottle")} activeAnnotationId={currentNoteId}>he was sore wounded in his breast by a spear wherewith a
      ...
      <p>
        ...
        a vat of silver that was moved by craft to open in the which lay <Annotation annotationId="180008sardines" annotationSelect={() => openNote("180008sardines")} activeAnnotationId={currentNoteId}>strange
        ...
        fecund <Annotation annotationId="030019kidneysofwheat" annotationSelect={() => openNote("030019kidneysofwheat")} activeAnnotationId={currentNoteId}>wheatkidneys</Annotation> out of Chaldee that by aid of certain angry spirits
      ...
      <p>
        <Annotation annotationId="140028goodsister" annotationSelect={() => openNote("140028goodsister")} activeAnnotationId={currentNoteId}>This meanwhile this good sister stood by the door</Annotation> and begged them at the
      ...
      <p>
        ...
        young Stephen that had <Annotation annotationId="010097latinquarterhat" annotationSelect={() => openNote("010097latinquarterhat")} activeAnnotationId={currentNoteId}>mien of a frere</Annotation> that was at head of the board
      ...
      <p>
        ...
        But, gramercy, what of <Annotation annotationId="020008infinitepossibilities" annotationSelect={() => openNote("020008infinitepossibilities")} activeAnnotationId={currentNoteId}>those Godpossibled souls that we nightly
        ...
        or by <Annotation annotationId="030149vampire" annotationSelect={() => openNote("030149vampire")} activeAnnotationId={currentNoteId}>potency of vampires</Annotation> <Annotation annotationId="090003hyde" annotationSelect={() => openNote("090003hyde")} activeAnnotationId={currentNoteId}>mouth to mouth</Annotation> or, as Virgilius saith, by the
        ...
        marvellous glad man and he averred that <Annotation annotationId="010129ubermensch" annotationSelect={() => openNote("010129ubermensch")} activeAnnotationId={currentNoteId}>he who stealeth from the poor
        lendeth</Annotation> 
        <span data-edition="ed1922" data-page="372"> </span>
        <Annotation annotationId="010129ubermensch" annotationSelect={() => openNote("010129ubermensch")} activeAnnotationId={currentNoteId}>to the Lord</Annotation> for he was of a wild manner when he was drunken and
      ...
      <p>
        ...
        for that evil hap and for his burial did him on a fair <Annotation annotationId="030091ruddywool" annotationSelect={() => openNote("030091ruddywool")} activeAnnotationId={currentNoteId}>corselet of
      ...
      <p>
        ...
        quod he, of this mazer and quaff ye this mead which is <Annotation annotationId="010106sacredpint" annotationSelect={() => openNote("010106sacredpint")} activeAnnotationId={currentNoteId}>not indeed parcel
        ...
        them glistering <Annotation annotationId="020014coinoftribute" annotationSelect={() => openNote("020014coinoftribute")} activeAnnotationId={currentNoteId}>coins of the tribute</Annotation> and goldsmiths' <Annotation annotationId="020035owenothing" annotationSelect={() => openNote("020035owenothing")} activeAnnotationId={currentNoteId}>notes the worth of
        ...
        postcreation. <Annotation annotationId="030102viditdeus" annotationSelect={() => openNote("030102viditdeus")} activeAnnotationId={currentNoteId}><i>Omnis caro ad te veniet</i>.</Annotation> No question but her name is
        ...
        up with by successive <Annotation annotationId="140004anastomosis" annotationSelect={() => openNote("140004anastomosis")} activeAnnotationId={currentNoteId}>anastomosis of navelcords</Annotation> sold us all,
        ...
        then stands she in the one denial or ignorancy with <Annotation annotationId="140039jackbuilt" annotationSelect={() => openNote("140039jackbuilt")} activeAnnotationId={currentNoteId}>Peter Piscator who
        lives in the house</Annotation> <span data-edition="ed1986" data-page="320"> </span><Annotation annotationId="140039jackbuilt" annotationSelect={() => openNote("140039jackbuilt")} activeAnnotationId={currentNoteId}>that Jack built</Annotation> and with Joseph the joiner patron of
        the happy demise of all unhappy marriages, <i><Annotation annotationId="010150fatherbird" annotationSelect={() => openNote("010150fatherbird")} activeAnnotationId={currentNoteId}>parceque M. Léo Taxil nous
        ...
        birth without pangs, <Annotation annotationId="030083nakedeve" annotationSelect={() => openNote("030083nakedeve")} activeAnnotationId={currentNoteId}>a body without blemish, a belly without bigness</Annotation>.
      ...
      <p>
        ...
        effect, saith <Annotation annotationId="010129ubermensch" annotationSelect={() => openNote("010129ubermensch")} activeAnnotationId={currentNoteId}>Zarathustra, sometime regius professor of French letters</Annotation>
        ...
        in my sight and to wax fat and kick like Jeshurum. <Annotation annotationId="020060jewmerchants" annotationSelect={() => openNote("020060jewmerchants")} activeAnnotationId={currentNoteId}>Therefore hast thou
        ...
        with our subsolar being. <Annotation annotationId="030093twomaries" annotationSelect={() => openNote("030093twomaries")} activeAnnotationId={currentNoteId}>The aged sisters draw us into life: we wail,
        ...
        of fasciated</Annotation> <span data-edition="ed1986" data-page="322"> </span><Annotation annotationId="030093twomaries" annotationSelect={() => openNote("030093twomaries")} activeAnnotationId={currentNoteId}>wattles: at last the cavity of a mountain</Annotation>, an occulted
        ...
        thereby be ushered nor whether to Tophet or to <Annotation annotationId="030008edenville" annotationSelect={() => openNote("030008edenville")} activeAnnotationId={currentNoteId}>Edenville</Annotation> in the like way
      ...
      <p>
        A black crack of <Annotation annotationId="020069streetshout" annotationSelect={() => openNote("020069streetshout")} activeAnnotationId={currentNoteId}>noise in the street</Annotation> here, alack, bawled back. Loud on
        ...
        not lag behind his lead. But this was only to dye his desperation <Annotation annotationId="030153crouched" annotationSelect={() => openNote("030153crouched")} activeAnnotationId={currentNoteId}>as
      ...
      <p>
        ...
        Why, he could not but hear unless he had plugged up <Annotation annotationId="140004anastomosis" annotationSelect={() => openNote("140004anastomosis")} activeAnnotationId={currentNoteId}>the tube
      ...
      <p>
        So Thursday sixteenth June Patk. Dignam laid in clay <Annotation annotationId="040067poordignam" annotationSelect={() => openNote("040067poordignam")} activeAnnotationId={currentNoteId}>of an apoplexy</Annotation> and
        ...
        aught they knew, <Annotation annotationId="010064dundrum" annotationSelect={() => openNote("010064dundrum")} activeAnnotationId={currentNoteId}>the big wind of last February</Annotation> a year that did havoc the
        ...
        pour came. <Annotation annotationId="140035holles" annotationSelect={() => openNote("140035holles")} activeAnnotationId={currentNoteId}>In Ely place, Baggot street, Duke's lawn, thence through
        ...
        her age and <Annotation annotationId="040004beefheels" annotationSelect={() => openNote("040004beefheels")} activeAnnotationId={currentNoteId}>beef to the heel</Annotation>, and all this while poured with rain and
        ...
        be seen any fair sabbath with a pair of his boys off <Annotation annotationId="010135bullockharbour" annotationSelect={() => openNote("010135bullockharbour")} activeAnnotationId={currentNoteId}>Bullock harbour</Annotation>
      ...
      <p>
        With this came up Lenehan to the feet of the table to say how <Annotation annotationId="020064telegraph" annotationSelect={() => openNote("020064telegraph")} activeAnnotationId={currentNoteId}>the letter
        ...
        his name), 'tis all about <Annotation annotationId="020054footandmouth" annotationSelect={() => openNote("020054footandmouth")} activeAnnotationId={currentNoteId}>Kerry cows that are to be butchered along of
        ...
        the roads with <Annotation annotationId="030078tinkers" annotationSelect={() => openNote("030078tinkers")} activeAnnotationId={currentNoteId}>the Romany folk</Annotation>, kidnapping a squire's heir by favour of
        ...
        that <Annotation annotationId="020055serumandvirus" annotationSelect={() => openNote("020055serumandvirus")} activeAnnotationId={currentNoteId}>he had dispatches from the emperor's chief tailtickler thanking
        ...
        <Annotation annotationId="010142greenstone" annotationSelect={() => openNote("010142greenstone")} activeAnnotationId={currentNoteId}>sent to our island by farmer Nicholas, the bravest cattlebreeder of them
        ...
        this day affirm that they would rather any time of the month <Annotation annotationId="010020ancientgreek" annotationSelect={() => openNote("010020ancientgreek")} activeAnnotationId={currentNoteId}>whisper
        ...
        <Annotation annotationId="170019localities" annotationSelect={() => openNote("170019localities")} activeAnnotationId={currentNoteId}>the wilds of Connemara</Annotation> or a husbandman in Sligo that was sowing as much
      ...
      <p>
        ...
        <Annotation annotationId="080028multiply" annotationSelect={() => openNote("080028multiply")} activeAnnotationId={currentNoteId}>multiply the inlets of happiness</Annotation>, sacrificing the inestimable jewel of
        ...
        island from its holder, <Annotation annotationId="030150malahide" annotationSelect={() => openNote("030150malahide")} activeAnnotationId={currentNoteId}>lord Talbot de Malahide, a Tory gentleman of
        note much in favour with our ascendancy party</Annotation>. He proposed to set up
        there a national fertilising farm to be named <Annotation annotationId="010065omphalos" annotationSelect={() => openNote("010065omphalos")} activeAnnotationId={currentNoteId}><i>Omphalos</i></Annotation> with an obelisk
      ...
      <p>
        ...
        mimic of <Annotation annotationId="010134mothergrogan" annotationSelect={() => openNote("010134mothergrogan")} activeAnnotationId={currentNoteId}>Mother Grogan</Annotation> (the most excellent creature of her sex though
      ...
      <p>
        ...
        is that they use in <Annotation annotationId="010068themater" annotationSelect={() => openNote("010068themater")} activeAnnotationId={currentNoteId}>the Mater
        ...
        blood in the <Annotation annotationId="010103waistcoat" annotationSelect={() => openNote("010103waistcoat")} activeAnnotationId={currentNoteId}>primrose vest</Annotation>, feigning a womanish simper and immodest
      ...
      <p>
        ...
        <span data-edition="ed1932" data-page="369"> </span><Annotation annotationId="030087pastlife" annotationSelect={() => openNote("030087pastlife")} activeAnnotationId={currentNoteId}>metempsychosis</Annotation> possessed by them, that the puerperal dormitory and the
      ...
      <p>
        ...
        <Annotation annotationId="030118royaldublins" annotationSelect={() => openNote("030118royaldublins")} activeAnnotationId={currentNoteId}>a gallant major</Annotation>, or to cast the most distant reflections upon her
        ...
        dispense his <Annotation annotationId="140003balmofgilead" annotationSelect={() => openNote("140003balmofgilead")} activeAnnotationId={currentNoteId}>balm of Gilead</Annotation> in <span data-edition="ed1986" data-page="334"> </span>nostrums and apothegms of dubious taste
      ...
      <p>
        ...
        infants occasionally born. The hypothesis of a <Annotation annotationId="010079akasicrecords" annotationSelect={() => openNote("010079akasicrecords")} activeAnnotationId={currentNoteId}>plasmic memory</Annotation>, advanced
        ...
        of brutes, his authority being his own avouchment in support of <Annotation annotationId="010020ancientgreek" annotationSelect={() => openNote("010020ancientgreek")} activeAnnotationId={currentNoteId}>fables
      ...
      <p>
        <Annotation annotationId="140020talebegan" annotationSelect={() => openNote("140020talebegan")} activeAnnotationId={currentNoteId}>But Malachias' tale began to freeze them with horror.</Annotation> He conjured up the
        scene before them. The secret panel beside the chimney slid back and
        in the recess appeared... <Annotation annotationId="010023haines" annotationSelect={() => openNote("010023haines")} activeAnnotationId={currentNoteId}>Haines!</Annotation> Which of us did not feel his <span data-edition="ed1932" data-page="372"> </span>flesh
        ...
        <Annotation annotationId="010141blamehistory" annotationSelect={() => openNote("010141blamehistory")} activeAnnotationId={currentNoteId}>history is to blame</Annotation>. Yes, it is true. I am the murderer of Samuel
        ...
        (<Annotation annotationId="010091speakirish" annotationSelect={() => openNote("010091speakirish")} activeAnnotationId={currentNoteId}>he recited some</Annotation>), laudanum (he raised the phial to his lips), camping
        out. In vain! His spectre stalks me. Dope is my only hope... Ah! (<Annotation annotationId="010025blackpanther" annotationSelect={() => openNote("010025blackpanther")} activeAnnotationId={currentNoteId}>The black panther!</Annotation> With a cry he suddenly vanished and the
      ...
      <p>
        ...
        young Leopold, as in <Annotation annotationId="060030retrospective" annotationSelect={() => openNote("060030retrospective")} activeAnnotationId={currentNoteId}>a retrospective arrangement</Annotation>, a mirror within
        ...
        house in Clanbrassil street to <Annotation annotationId="050020highschool" annotationSelect={() => openNote("050020highschool")} activeAnnotationId={currentNoteId}>the high school</Annotation>, his booksatchel on
      ...
      <p>
        ...
        phantoms: all is gone. <Annotation annotationId="040061agendath" annotationSelect={() => openNote("040061agendath")} activeAnnotationId={currentNoteId}>Agendath</Annotation> is a waste land, a home of
        screechowls and the sandblind upupa. Netaim, the golden, is no more. <Annotation annotationId="080008parallax" annotationSelect={() => openNote("080008parallax")} activeAnnotationId={currentNoteId}>And
        ...
        trooping to <Annotation annotationId="040053deadsea" annotationSelect={() => openNote("040053deadsea")} activeAnnotationId={currentNoteId}>the sunken sea, <i>Lacus Mortis</i></Annotation>. Ominous revengeful zodiacal
      ...
      <p>
        ...
        of <Annotation annotationId="030087pastlife" annotationSelect={() => openNote("030087pastlife")} activeAnnotationId={currentNoteId}>metempsychosis</Annotation>, it is she, the everlasting bride, harbinger of the
      ...
      <p>
        Francis was reminding Stephen of years before when they <span data-edition="ed1961" data-page="414"> </span>had been <Annotation annotationId="050052conmee" annotationSelect={() => openNote("050052conmee")} activeAnnotationId={currentNoteId}>at
        ...
        my call? Who supposes it? I, Bous Stephanoumenos, <Annotation annotationId="020065bullockbefriending" annotationSelect={() => openNote("020065bullockbefriending")} activeAnnotationId={currentNoteId}>bullockbefriending
        bard</Annotation>, am lord and giver of their life. <Annotation annotationId="010020ancientgreek" annotationSelect={() => openNote("010020ancientgreek")} activeAnnotationId={currentNoteId}>He encircled his gadding hair
        ...
        Warily, Malachi whispered, preserve a <Annotation annotationId="010018druids" annotationSelect={() => openNote("010018druids")} activeAnnotationId={currentNoteId}>druid</Annotation> silence. His soul is far
      ...
      <p>
        ...
        before's observations about boyhood days and the turf, <Annotation annotationId="160008littlepills" annotationSelect={() => openNote("160008littlepills")} activeAnnotationId={currentNoteId}>recollecting two</Annotation>
        <span data-edition="ed1939" data-page="299"> </span>
        <Annotation annotationId="160008littlepills" annotationSelect={() => openNote("160008littlepills")} activeAnnotationId={currentNoteId}>or three private transactions of his own</Annotation> which the other two were as
      ...
      <p>
        ...
        explorer's kit of tweed shorts and salted cowhide <Annotation annotationId="020076brogues" annotationSelect={() => openNote("020076brogues")} activeAnnotationId={currentNoteId}>brogues</Annotation> contrasted
      ...
      <p>
        It had better be stated here and now at the outset that the <Annotation annotationId="010041killergod" annotationSelect={() => openNote("010041killergod")} activeAnnotationId={currentNoteId}>perverted
        ...
        light philosophy, instructive pictures, <Annotation annotationId="080005venus" annotationSelect={() => openNote("080005venus")} activeAnnotationId={currentNoteId}>plastercast reproductions of
        ...
        up their residence (modern science has conclusively shown that <Annotation annotationId="010079akasicrecords" annotationSelect={() => openNote("010079akasicrecords")} activeAnnotationId={currentNoteId}>only the
        ...
        that <Annotation annotationId="010041killergod" annotationSelect={() => openNote("010041killergod")} activeAnnotationId={currentNoteId}>an omnivorous being which can masticate, deglute, digest and
        ...
        and 31 Holles street, of which, as is well known, <Annotation annotationId="140038drhorne" annotationSelect={() => openNote("140038drhorne")} activeAnnotationId={currentNoteId}>Dr A. Horne (Lic. in
      ...
      <p>
        ...
        Mr Purefoy in <Annotation annotationId="080013dublincastle" annotationSelect={() => openNote("080013dublincastle")} activeAnnotationId={currentNoteId}>the Treasury Remembrancer's office, Dublin Castle</Annotation>. And so
      ...
      <p>
        ...
        from an ear, bringing out <Annotation annotationId="040063happywarmth" annotationSelect={() => openNote("040063happywarmth")} activeAnnotationId={currentNoteId}>the foreign warmth of the skin</Annotation> so daintily
      ...
      <p>
        ...
        tumultuously, off for a minute's race, all bravely legging it, <Annotation annotationId="040089denzille" annotationSelect={() => openNote("040089denzille")} activeAnnotationId={currentNoteId}>Burke's
      ...
      <p>
        The air without is <Annotation annotationId="180010dewy" annotationSelect={() => openNote("180010dewy")} activeAnnotationId={currentNoteId}>impregnated with raindew moisture</Annotation>, life essence
        ...
        thine!) in the countinghouse? Head up! <Annotation annotationId="180010dewy" annotationSelect={() => openNote("180010dewy")} activeAnnotationId={currentNoteId}> For every newbegotten thou shalt
      ...
      <p>
        ...
        Where you slep las nigh? <Annotation annotationId="040090naggin" annotationSelect={() => openNote("040090naggin")} activeAnnotationId={currentNoteId}>Timothy of the battered naggin.</Annotation> Like ole
        ...
        drunken <Annotation annotationId="010097latinquarterhat" annotationSelect={() => openNote("010097latinquarterhat")} activeAnnotationId={currentNoteId}>minister</Annotation> coming out of the maternity hospal! <i>Benedicat vos
        omnipotens Deus, Pater et Filius</i>. A make, mister. <Annotation annotationId="040089denzille" annotationSelect={() => openNote("040089denzille")} activeAnnotationId={currentNoteId}>The Denzille lane
        ...
        parasangs. Slattery's mounted foot. Where's that bleeding awfur? <Annotation annotationId="010097latinquarterhat" annotationSelect={() => openNote("010097latinquarterhat")} activeAnnotationId={currentNoteId}>Parson
        ...
        Ayes have it. <Annotation annotationId="010064dundrum" annotationSelect={() => openNote("010064dundrum")} activeAnnotationId={currentNoteId}>To be printed and bound at the </Annotation><Annotation annotationId="010018druids" annotationSelect={() => openNote("010018druids")} activeAnnotationId={currentNoteId}>Druiddrum</Annotation> press by two
      ...
      <p>
        ...
        gone. Yours? Mead of our fathers for <Annotation annotationId="010129ubermensch" annotationSelect={() => openNote("010129ubermensch")} activeAnnotationId={currentNoteId}>the <i>Uebermensch</i></Annotation>. Dittoh. Five
        ...
        again when the old. <Annotation annotationId="030045absinthe" annotationSelect={() => openNote("030045absinthe")} activeAnnotationId={currentNoteId}>Absinthe</Annotation> for me, savvy? <i>Caramba!</i> Have an eggnog or
        ...
        gluepot. Sir? <Annotation annotationId="040047potato" annotationSelect={() => openNote("040047potato")} activeAnnotationId={currentNoteId}>Spud again the rheumatiz?</Annotation> All poppycock, you'll scuse me
        ...
        Spit in your own eye, boss! <Annotation annotationId="010043mummer" annotationSelect={() => openNote("010043mummer")} activeAnnotationId={currentNoteId}>Mummer</Annotation>'s wire. Cribbed out of Meredith.
        Jesified orchidised polycimical <Annotation annotationId="010008jesuit" annotationSelect={() => openNote("010008jesuit")} activeAnnotationId={currentNoteId}>jesuit</Annotation>! Aunty mine's writing Pa Kinch.
        <Annotation annotationId="010001buckmulligan" annotationSelect={() => openNote("010001buckmulligan")} activeAnnotationId={currentNoteId}>Baddybad Stephen lead astray goodygood Malachi.</Annotation>
      </p>
      <p>
        ...
        cove to his gentry mort. <Annotation annotationId="080005venus" annotationSelect={() => openNote("080005venus")} activeAnnotationId={currentNoteId}>Venus Pandemos.</Annotation> <i>Les petites femmes</i>. <Annotation annotationId="010127photogirl" annotationSelect={() => openNote("010127photogirl")} activeAnnotationId={currentNoteId}>Bold bad
        girl from the town of Mullingar.</Annotation> Tell her I was axing at her. Hauding
        Sara by the wame. On the road to <Annotation annotationId="030150malahide" annotationSelect={() => openNote("030150malahide")} activeAnnotationId={currentNoteId}>Malahide</Annotation>. Me? <span data-edition="ed1961" data-page="425"> </span>If she who seduced me had
      ...
      <p>
        ...
        big bug Bass to the depot. Shove him <Annotation annotationId="010019money" annotationSelect={() => openNote("010019money")} activeAnnotationId={currentNoteId}>a joey</Annotation> and grahamise. Mare on form hot 
        ...
        harman beck copped the game. Madden back Madden's a maddening back. <Annotation annotationId="010088archangelmichael" annotationSelect={() => openNote("010088archangelmichael")} activeAnnotationId={currentNoteId}>O,
      ...
      <p>
        ...
        Cut and come again. Right Boniface! <Annotation annotationId="030045absinthe" annotationSelect={() => openNote("030045absinthe")} activeAnnotationId={currentNoteId}>Absinthe the lot. <i>Nos omnes
      ...
      <p>
        ...
        by James. Wants it real bad. D'ye ken bare socks? Seedy cuss in <Annotation annotationId="010050dottyville" annotationSelect={() => openNote("010050dottyville")} activeAnnotationId={currentNoteId}>the
        ...
        a prosperous cit. <Annotation annotationId="140039jackbuilt" annotationSelect={() => openNote("140039jackbuilt")} activeAnnotationId={currentNoteId}>Man all tattered and torn that married a maiden all
      ...
      <p>
        Lynch! Hey? Sign on long o me. <Annotation annotationId="040089denzille" annotationSelect={() => openNote("040089denzille")} activeAnnotationId={currentNoteId}>Denzille lane this way. Change here for
        ...
        Whisper, who the sooty hell's the johnny in the black duds? Hush! <Annotation annotationId="020060jewmerchants" annotationSelect={() => openNote("020060jewmerchants")} activeAnnotationId={currentNoteId}>Sinned
