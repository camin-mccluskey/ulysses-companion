const OxenOfTheSun = ({openNote}) => {
  return (
    <div>
      <p></p>
      <center><font size="+2">[14]</font></center>
      <br/>
      <button className="bg-gray-300 bg-center bg-cover hover:bg-green-300" onClick={() => openNote("140032deshileamus")}>Deshil Holles Eamus.</button> Deshil <button className="bg-gray-300 bg-center bg-cover hover:bg-green-300" onClick={() => openNote("140035holles")}>Holles</button> Eamus. Deshil Holles Eamus.
      <p></p>
      <p>
        Send us <button className="bg-gray-300 bg-center bg-cover hover:bg-green-300" onClick={() => openNote("140037brightone")}>bright one, light one, Horhorn</button>, quickening and wombfruit. Send
        us bright one, light one, Horhorn, quickening and wombfruit. Send us
        bright one, light one, Horhorn, quickening and wombfruit.
      </p>
      <p>
        <button className="bg-gray-300 bg-center bg-cover hover:bg-green-300" onClick={() => openNote("140036hoopsaboyaboy")}>Hoopsa boyaboy hoopsa!</button> Hoopsa boyaboy hoopsa! Hoopsa boyaboy hoopsa!
      </p>
      <p>
        <button className="bg-gray-300 bg-center bg-cover hover:bg-green-300" onClick={() => openNote("140033universally")}>Universally that person's acumen is esteemed very little perceptive</button>
        ...
        <span data-edition="ed1932" data-page="346"> </span>when by general consent they affirm that other circumstances being
        ...
        can contend against <button className="bg-gray-300 bg-center bg-cover hover:bg-green-300" onClick={() => openNote("080028multiply")}> the bounty of increase</button> so it behoves every most just
        ...
        <span data-edition="ed1922" data-page="366"> </span>
      ...
      <p>
        <button className="bg-gray-300 bg-center bg-cover hover:bg-green-300" onClick={() => openNote("140031historians")}>It is not why therefore we shall wonder if, as the best historians
        relate,</button> among the Celts, who nothing that was not in its nature
        ...
        commensurate and 
        <span data-edition="ed1939" data-page="277"> </span>
        therefore a plan was by them adopted (whether by having
      ...
      <span data-edition="ed1932" data-page="347"> </span>
      <p>
      ...
      <p>
        <button className="bg-gray-300 bg-center bg-cover hover:bg-green-300" onClick={() => openNote("140040beforeborn")}>Before born bliss babe had. Within womb won he worship.</button> Whatever in that
        ...
        and human, the cogitation of which by 
        <span data-edition="ed1922" data-page="367"> </span>
        sejunct females is to tumescence
        conducive or eases issue in the high sunbright wellbuilt fair home of
        mothers when, ostensibly far <span data-edition="ed1961" data-page="384"> </span>gone and reproductitive, it is come by her
        thereto to lie in, her term up.
      </p>
      <p>
        Some man that wayfaring was stood by housedoor at night's oncoming. <button className="bg-gray-300 bg-center bg-cover hover:bg-green-300" onClick={() => openNote("020061wanderers")}>Of
        Israel's folk was that man that on earth wandering far had fared.</button> Stark
        ruth of man his errand that him lone led till that house.
      </p>
      <p>
        Of that house <button className="bg-gray-300 bg-center bg-cover hover:bg-green-300" onClick={() => openNote("140038drhorne")}>A. Horne</button> is lord. <button className="bg-gray-300 bg-center bg-cover hover:bg-green-300" onClick={() => openNote("140035holles")}>Seventy beds</button> keeps he there teeming
        ...
        in ward sleepless. Smarts they still, sickness soothing: <button className="bg-gray-300 bg-center bg-cover hover:bg-green-300" onClick={() => openNote("140035holles")}>in twelve moons
        thrice an hundred</button>. Truest bedthanes they twain are, for Horne holding
        wariest ward.
      </p>
      <span data-edition="ed1986" data-page="315"> </span>
      <p>
        ...
        lightens in eyeblink Ireland's westward welkin. Full she dread that
      ...
      <p>
        ...
        and seafloor nine years had long outwandered. Once her in <span data-edition="ed1932" data-page="348"> </span>townhithe
      ...
      <span data-edition="ed1939" data-page="278"> </span>
      <p>
        ...
        through bellycrab three year agone come Childermas and she <span data-edition="ed1961" data-page="385"> </span>prayed to God
      ...
      <p>
        <button className="bg-gray-300 bg-center bg-cover hover:bg-green-300" onClick={() => openNote("140030everyman")}>Therefore, everyman, look to that last end that is thy death</button> and the dust 
      ...
      <p>
        ...
        birth. Then she set it forth all to him
        ...
        motherhood and he wondered to look on her face that was a young face for
        any man to see but yet was she left after long years a handmaid. Nine
        twelve bloodflows chiding her childless.
      </p>
      <p>
        <button className="bg-gray-300 bg-center bg-cover hover:bg-green-300" onClick={() => openNote("140029thecastle")}>And whiles they spake the door of the castle was opened</button> and there nighed
        ...
        had had ado each with other in <button className="bg-gray-300 bg-center bg-cover hover:bg-green-300" onClick={() => openNote("010068themater")}>the house of misericord</button> where this
        learningknight lay by cause the traveller Leopold came there to be
        <span data-edition="ed1932" data-page="349"> </span>healed for <button className="bg-gray-300 bg-center bg-cover hover:bg-green-300" onClick={() => openNote("040040bluebottle")}>he was sore wounded in his breast by a spear wherewith a
        horrible and dreadful dragon was smitten him</button> for which he did do make
        ...
        for <span data-edition="ed1961" data-page="386"> </span>a space being sore of limb after many marches environing in divers
      ...
      <p>
        ...
        flames that they fix in the horns of buffalos and stags that there
        abound marvellously. And there were vessels that are wrought by magic of
        Mahound out of seasand and the 
        <span data-edition="ed1922" data-page="369"> </span>
        air by a warlock with 
        <span data-edition="ed1939" data-page="279"> </span>
        his breath that he
        ...
        a vat of silver that was moved by craft to open in the which lay <button className="bg-gray-300 bg-center bg-cover hover:bg-green-300" onClick={() => openNote("180008sardines")}>strange
        fishes withouten heads</button> though misbelieving men nie that this be possible
        ...
        fecund <button className="bg-gray-300 bg-center bg-cover hover:bg-green-300" onClick={() => openNote("030019kidneysofwheat")}>wheatkidneys</button> out of Chaldee that by aid of certain angry spirits
      ...
      <p>
        ...
        his neighbour nist not of his wile. And he sat down in that castle with
        them for to rest him there awhile. Thanked be Almighty God.
      </p>
      <span data-edition="ed1932" data-page="350"> </span>
      <p>
        <button className="bg-gray-300 bg-center bg-cover hover:bg-green-300" onClick={() => openNote("140028goodsister")}>This meanwhile this good sister stood by the door</button> and begged them at the
        ...
        a franklin that hight Lenehan on that side the table <span data-edition="ed1961" data-page="387"> </span>that was older than
        ...
        <span data-edition="ed1922" data-page="370"> </span>
        service to lady gentle pledged him courtly in the cup. Woman's woe with wonder
        pondering.
      </p>
      <p>
        ...
        young Stephen that had <button className="bg-gray-300 bg-center bg-cover hover:bg-green-300" onClick={() => openNote("010097latinquarterhat")}>mien of a frere</button> that was at head of the board
        ...
        <span data-edition="ed1939" data-page="280"> </span>
        insomuch as they feasted him for that
      ...
      <p>
        ...
        put such case it were hard the wife to die (for so it had fallen<span data-edition="ed1932" data-page="351"> </span>out a
        ...
        death all leeches and pothecaries had taken counsel of her <span data-edition="ed1961" data-page="388"> </span>case). And
        ...
        but all cried with one <span data-edition="ed1986" data-page="318"> </span>acclaim nay, by our Virgin Mother, the wife
        ...
        affair and when he said how that she was dead and how for holy religion sake by
        ...
        all wondrous grieved. To whom young Stephen 
        <span data-edition="ed1922" data-page="371"> </span>
        ...
        But, gramercy, what of <button className="bg-gray-300 bg-center bg-cover hover:bg-green-300" onClick={() => openNote("020008infinitepossibilities")}>those Godpossibled souls that we nightly
        impossibilise</button>, which is the sin against the Holy Ghost, Very God, Lord
        ...
        or by <button className="bg-gray-300 bg-center bg-cover hover:bg-green-300" onClick={() => openNote("030149vampire")}>potency of vampires</button> <button className="bg-gray-300 bg-center bg-cover hover:bg-green-300" onClick={() => openNote("090003hyde")}>mouth to mouth</button> or, as Virgilius saith, by the
        ...
        greater glory whereas that earthly mother which was but a dam to bring forth
        beastly should die by canon for so saith 
        <span data-edition="ed1939" data-page="281"> </span>
        he that holdeth the fisherman's
        ...
        experience of so seldom seen an accident it was good for that mother
        ...
        marvellous glad man and he averred that <button className="bg-gray-300 bg-center bg-cover hover:bg-green-300" onClick={() => openNote("010129ubermensch")}>he who stealeth from the poor
        lendeth</button> 
        <span data-edition="ed1922" data-page="372"> </span>
        <button className="bg-gray-300 bg-center bg-cover hover:bg-green-300" onClick={() => openNote("010129ubermensch")}>to the Lord</button> for he was of a wild manner when he was drunken and
      ...
      <p>
        ...
        for that evil hap and for his burial did him on a fair <button className="bg-gray-300 bg-center bg-cover hover:bg-green-300" onClick={() => openNote("030091ruddywool")}>corselet of
        lamb's wool</button>, the flower of the flock, lest he might perish utterly and
        ...
        for <span data-edition="ed1961" data-page="390"> </span>young Stephen for that he lived riotously with those wastrels and
      ...
      <p>
        ...
        quod he, of this mazer and quaff ye this mead which is <button className="bg-gray-300 bg-center bg-cover hover:bg-green-300" onClick={() => openNote("010106sacredpint")}>not indeed parcel
        of my body but my soul's bodiment. Leave ye fraction of bread to them
        that live by bread alone.</button> Be not afeard neither for any want for this
        will comfort more than the other will dismay. See ye here. And he showed
        them glistering <button className="bg-gray-300 bg-center bg-cover hover:bg-green-300" onClick={() => openNote("020014coinoftribute")}>coins of the tribute</button> and goldsmiths' <button className="bg-gray-300 bg-center bg-cover hover:bg-green-300" onClick={() => openNote("020035owenothing")}>notes the worth of
        two pound nineteen shilling that he had, he said, for a song which he
        writ</button>. They all admired to see the foresaid riches in such dearth of
        ...
        postcreation. <button className="bg-gray-300 bg-center bg-cover hover:bg-green-300" onClick={() => openNote("030102viditdeus")}><i>Omnis caro ad te veniet</i>.</button> No question but her name is
        ...
        up with by successive <button className="bg-gray-300 bg-center bg-cover hover:bg-green-300" onClick={() => openNote("140004anastomosis")}>anastomosis of navelcords</button> sold us all,
        ...
        then stands she in the one denial or ignorancy with <button className="bg-gray-300 bg-center bg-cover hover:bg-green-300" onClick={() => openNote("140039jackbuilt")}>Peter Piscator who
        lives in the house</button> <span data-edition="ed1986" data-page="320"> </span><button className="bg-gray-300 bg-center bg-cover hover:bg-green-300" onClick={() => openNote("140039jackbuilt")}>that Jack built</button> and with Joseph the joiner patron of
        the happy demise of all unhappy marriages, <i><button className="bg-gray-300 bg-center bg-cover hover:bg-green-300" onClick={() => openNote("010150fatherbird")}>parceque M. Léo Taxil nous
        a dit que qui l'avait mise dans cette fichue position c'était le
        sacré pigeon</button></i>, <i>ventre de Dieu! Entweder</i> transubstantiality <i>oder</i>
        ...
        birth without pangs, <button className="bg-gray-300 bg-center bg-cover hover:bg-green-300" onClick={() => openNote("030083nakedeve")}>a body without blemish, a belly without bigness</button>.
      ...
      <p>
        ...
        sing a bawdy catch <i>Staboo Stabella</i> about a wench that was put in pod
        of a jolly swashbuckler in Almany which he did now attack:
        <i>The first three months she was not well, Staboo,</i> when here nurse
        ...
        no gasteful<span data-edition="ed1932" data-page="354"> </span>turmoil might shorten the honour of her guard. It was an
        ...
        all embraided and they reclaimed the churl with civil rudeness some and with menace of blandishments others whiles all chode
        with him, a murrain seize the dolt, what a devil he would be at, thou
        chuff, thou puny, thou got in the peasestraw, thou losel, thou chitterling,
      ...
      <p>
        ...
        intershowed it too, waxing merry 
        <span data-edition="ed1922" data-page="374"> </span>
        ...
        burning of nard and tapers, on a bridebed while clerks <span data-edition="ed1961" data-page="392"> </span>sung kyries and
        the anthem <i>Ut novetur sexus omnis corporis mysterium</i> till she was
        there unmaided. He gave them then a much admirable hymen minim by those
        delicate poets Master John Fletcher and <span data-edition="ed1986" data-page="321"> </span>Master Francis Beaumont that is
        in their <i>Maid's Tragedy</i> that was writ for a like twining of lovers:
        <i>To bed, to bed</i> was the burden of it to be played with accompanable
        ...
        <span data-edition="ed1939" data-page="283"> </span>
        and Lecher
        ...
        and she of <span data-edition="ed1932" data-page="355"> </span>the stews to make shift with in delights amorous for life ran
        ...
        effect, saith <button className="bg-gray-300 bg-center bg-cover hover:bg-green-300" onClick={() => openNote("010129ubermensch")}>Zarathustra, sometime regius professor of French letters</button>
        ...
        in my sight and to wax fat and kick like Jeshurum. <button className="bg-gray-300 bg-center bg-cover hover:bg-green-300" onClick={() => openNote("020060jewmerchants")}>Therefore hast thou
        sinned against the light</button> and hast made me, thy lord, to be the slave of
        ...
        a merchant of jalaps and didst deny me to the Roman and the Indian of
        ...
        in the dark ways of my bitterness: and with a kiss of ashes 
        <span data-edition="ed1922" data-page="375"> </span>
        hast thou
        kissed my mouth. This tenebrosity of the interior, he proceeded to say,
        hath not been illumined by <span data-edition="ed1961" data-page="393"> </span>the wit of the septuagint nor so much as
        ...
        most proper <i>ubi</i> and <i>quomodo</i>. And as the ends and ultimates of
        ...
        with our subsolar being. <button className="bg-gray-300 bg-center bg-cover hover:bg-green-300" onClick={() => openNote("030093twomaries")}>The aged sisters draw us into life: we wail,
        ...
        of fasciated</button> <span data-edition="ed1986" data-page="322"> </span><button className="bg-gray-300 bg-center bg-cover hover:bg-green-300" onClick={() => openNote("030093twomaries")}>wattles: at last the cavity of a mountain</button>, an occulted
        ...
        thereby be ushered nor whether to Tophet or to <button className="bg-gray-300 bg-center bg-cover hover:bg-green-300" onClick={() => openNote("030008edenville")}>Edenville</button> in the like way
      ...
      <p>
        Thereto Punch Costello roared out mainly <i>Etienne chanson</i> but he loudly
      ...
      <p><i>Behold the mansion reared by dedal Jack <br/>
        ...
        In the proud cirque of Jackjohn's bivouac.</i>
      </p>
      <span data-edition="ed1939" data-page="284"> </span>
      <p>
        A black crack of <button className="bg-gray-300 bg-center bg-cover hover:bg-green-300" onClick={() => openNote("020069streetshout")}>noise in the street</button> here, alack, bawled back. Loud on
        ...
        mock and some jeer <span data-edition="ed1961" data-page="394"> </span>and Punch Costello fell hard again to his yale which
        Master 
        <span data-edition="ed1922" data-page="376"> </span>
        ...
        not lag behind his lead. But this was only to dye his desperation <button className="bg-gray-300 bg-center bg-cover hover:bg-green-300" onClick={() => openNote("030153crouched")}>as
        cowed he crouched</button> in Horne's hall. He drank indeed at one draught to
      ...
      <p>
        ...
        Why, he could not but hear unless he had plugged up <button className="bg-gray-300 bg-center bg-cover hover:bg-green-300" onClick={() => openNote("140004anastomosis")}>the tube
        Understanding</button> (which he had not done). For through that tube he saw that
        ...
        path by her flatteries that she said to him as, Ho, you <span data-edition="ed1961" data-page="395"> </span>pretty man, turn
      ...
      <p>
        ...
        Bird-in-the-Hand 
        <span data-edition="ed1922" data-page="377"> </span>
        ...
        but notion and they could conceive no thought of it for, 
        <span data-edition="ed1939" data-page="285"> </span>
        first, Two-in-the-Bush whither she ticed them was the very goodliest grot and
        ...
        very grievous rage that he would presently lift his arm and
      ...
      <p>
        So Thursday sixteenth June Patk. Dignam laid in clay <button className="bg-gray-300 bg-center bg-cover hover:bg-green-300" onClick={() => openNote("040067poordignam")}>of an apoplexy</button> and
        ...
        aught they knew, <button className="bg-gray-300 bg-center bg-cover hover:bg-green-300" onClick={() => openNote("010064dundrum")}>the big wind of last February</button> a year that did havoc the
        ...
        weatherwise poring up at them and some sheet <span data-edition="ed1961" data-page="396"> </span>lightnings at first and
        ...
        pour came. <button className="bg-gray-300 bg-center bg-cover hover:bg-green-300" onClick={() => openNote("140035holles")}>In Ely place, Baggot street, Duke's lawn, thence through
        Merrion green up to Holles street</button> a swash of water running that was
        ...
        college lands) Mal. Mulligan a gentleman's gentleman that had but come from 
        <span data-edition="ed1922" data-page="378"> </span>
        Mr Moore's the writer's (that was a papish but is now, folk say,
        ...
        her age and <button className="bg-gray-300 bg-center bg-cover hover:bg-green-300" onClick={() => openNote("040004beefheels")}>beef to the heel</button>, and all this while poured with rain and
        ...
        T. Lenehan, very sad for a racinghorse he fancied and Stephen D. Leop. Bloom
        ...
        on the stools, poor body, two days past her term, the <span data-edition="ed1932" data-page="359"> </span>midwives sore put
        to it and can't deliver, she queasy for a bowl 
        <span data-edition="ed1939" data-page="286"> </span>
        ...
        be seen any fair sabbath with a pair of his boys off <button className="bg-gray-300 bg-center bg-cover hover:bg-green-300" onClick={() => openNote("010135bullockharbour")}>Bullock harbour</button>
      ...
      <p>
        With this came up Lenehan to the feet of the table to say how <button className="bg-gray-300 bg-center bg-cover hover:bg-green-300" onClick={() => openNote("020064telegraph")}>the letter
        was in that night's gazette</button> and he made a show to find it about him
        ...
        went for a merryandrew 
        <span data-edition="ed1922" data-page="379"> </span>
        or honest pickle and what belonged of women,
        ...
        his name), 'tis all about <button className="bg-gray-300 bg-center bg-cover hover:bg-green-300" onClick={() => openNote("020054footandmouth")}>Kerry cows that are to be butchered along of
        the plague</button>. But they can go hang, says he with a wink, for me with their
        ...
        <span data-edition="ed1932" data-page="360"> </span>which was indeed the chief design of his embassy as he was sharpset.
        <i>Mort aux vaches</i>, says Frank then in the French language that had been
        ...
        school to learn his letters and the use of <span data-edition="ed1961" data-page="398"> </span>the globes, matriculated at
        ...
        the roads with <button className="bg-gray-300 bg-center bg-cover hover:bg-green-300" onClick={() => openNote("030078tinkers")}>the Romany folk</button>, kidnapping a squire's heir by favour of
        ...
        <span data-edition="ed1939" data-page="287"> </span>
        a pint
        ...
        wether wools having been some years before actuary for Mr Joseph Cuffe,
        ...
        that <button className="bg-gray-300 bg-center bg-cover hover:bg-green-300" onClick={() => openNote("020055serumandvirus")}>he had dispatches from the emperor's chief tailtickler thanking
        him for the hospitality, that was sending over Doctor Rinderpest, the
        bestquoted cowcatcher in all Muscovy, with a bolus or two of physic</button> to
        ...
        <button className="bg-gray-300 bg-center bg-cover hover:bg-green-300" onClick={() => openNote("010142greenstone")}>sent to our island by farmer Nicholas, the bravest cattlebreeder of them
        all, with an emerald ring in his nose</button>. True for you, says Mr Vincent
        ...
        <span data-edition="ed1932" data-page="361"> </span>What for that, says Mr Dixon, but before he came over farmer Nicholas
        that was a eunuch had him properly gelded by a college of doctors who
        <span data-edition="ed1961" data-page="399"> </span>were no better off than himself. So be off now, says he, and do all my
        ...
        this day affirm that they would rather any time of the month <button className="bg-gray-300 bg-center bg-cover hover:bg-green-300" onClick={() => openNote("010020ancientgreek")}>whisper
        in his ear in the dark of a cowhouse</button> or get a lick on the nape from his
        ...
        on a hillock in the middle of the 
        <span data-edition="ed1922" data-page="381"> </span>
        ...
        <button className="bg-gray-300 bg-center bg-cover hover:bg-green-300" onClick={() => openNote("170019localities")}>the wilds of Connemara</button> or a husbandman in Sligo that was sowing as much
        ...
        up with his horns whatever was planted and all
        by lord Harry's orders. There was bad blood between them at first, says
        Mr <span data-edition="ed1986" data-page="327"> </span>Vincent, and the lord Harry called farmer Nicholas all the old Nicks
        ...
        with <span data-edition="ed1961" data-page="400"> </span>pitchforks) he discovered in himself a wonderful likeness to a bull
        and on picking up a blackthumbed <span data-edition="ed1932" data-page="362"> </span>chapbook that he kept in the pantry
        he found sure enough that he was a lefthanded descendant of the famous
        champion bull of the Romans, <i>Bos Bovum</i>, which is good bog Latin for
        ...
        out for a walk he filled his pockets with chalk to write it up on what
      ...
      <p><i>—{" "}Pope Peter's but a pissabed.
        </i>
      </p>
      <i>
      </i>
      ...
      <p>
        ...
        <span data-edition="ed1922" data-page="382"> </span>
        doorway as the students were finishing their apologue accompanied with a friend
        ...
        printed <span data-edition="ed1961" data-page="401"> </span>in fair italics: <i>Mr Malachi Mulligan. Fertiliser and Incubator.
        Lambay Island</i>. His project, as he went on to expound, was to withdraw
        ...
        to the noblest task for <span data-edition="ed1986" data-page="328"> </span>which our bodily organism has been framed. Well,
        let us hear of it, good my friend, said Mr Dixon. I make no doubt it
        smacks of wenching. Come, be seated, both. 'Tis as <span data-edition="ed1932" data-page="363"> </span>cheap sitting as
        standing. Mr Mulligan accepted of the invitation and, expatiating on
        his design, told his hearers that he had been led into this thought by
        a consideration of the 
        <span data-edition="ed1939" data-page="289"> </span>
        causes of sterility, both the inhibitory and the
        ...
        <button className="bg-gray-300 bg-center bg-cover hover:bg-green-300" onClick={() => openNote("080028multiply")}>multiply the inlets of happiness</button>, sacrificing the inestimable jewel of
        ...
        island from its holder, <button className="bg-gray-300 bg-center bg-cover hover:bg-green-300" onClick={() => openNote("030150malahide")}>lord Talbot de Malahide, a Tory gentleman of
        note much in favour with our ascendancy party</button>. He proposed to set up
        there a national fertilising farm to be named <button className="bg-gray-300 bg-center bg-cover hover:bg-green-300" onClick={() => openNote("010065omphalos")}><i>Omphalos</i></button> with an obelisk
        ...
        <span data-edition="ed1922" data-page="383"> </span>
        ...
        latter prolific <span data-edition="ed1961" data-page="402"> </span>rodents being highly recommended for his purpose, both
        ...
        to carry coals to Newcastle. Mr Mulligan however <span data-edition="ed1932" data-page="364"> </span>made court to the
        ...
        contention: <i>Talis ac tanta depravatio hujus seculi, O quirites,
        ut matresfamiliarum nostrae lascivas cujuslibet semiviri libici
        titillationes</i> <span data-edition="ed1986" data-page="329"> </span><i>testibus ponderosis atque excelsis erectionibus
        centurionum Romanorum magnopere anteponunt</i> while for those of ruder
      ...
      <p>
        ...
        passage that had befallen him, could not forbear to tell it his
        ...
        a civil 
        <span data-edition="ed1939" data-page="290"> </span>
        bow and said, Pray, sir, was you in need of any professional
        ...
        interesting condition, poor lady, from woman's woe (and here he fetched
        ...
        as with the noted physician, <span data-edition="ed1961" data-page="403"> </span>Mr Austin Meldon, to a wolf in the stomach.
        ...
        mimic of <button className="bg-gray-300 bg-center bg-cover hover:bg-green-300" onClick={() => openNote("010134mothergrogan")}>Mother Grogan</button> (the most excellent creature of her sex though
      ...
      <p>
        ...
        <span data-edition="ed1932" data-page="365"> </span>not achieved so nice a gesture) to which was united an equivalent but
        contrary balance of the bottle asked the narrator as plainly as was ever
        done in words if he might treat him with a cup of it. <i>Mais bien sûr</i>,
        noble stranger, said he cheerily, <i>et mille compliments</i>. That you may
        ...
        <span data-edition="ed1986" data-page="330"> </span>bosom, out popped a locket that hung from a silk riband, that very
        ...
        feastday as she told me) in such an artless disorder, of so
        ...
        Thrice happy will he be whom so amiable a <span data-edition="ed1961" data-page="404"> </span>creature will bless with her
        ...
        years. But 
        <span data-edition="ed1922" data-page="385"> </span>
        indeed, sir, I wander from the point. How mingled and
        imperfect are all our sublunary joys. Maledicity! Would to God that foresight had remembered me to take my
        cloak along! I could weep to think of 
        <span data-edition="ed1939" data-page="291"> </span>
        it. Then, though it had poured
        ...
        thousand thunders, I know of a <i>marchand de capotes</i>, Monsieur Poyntz,
        ...
        (I have just cracked a half bottle <i>avec lui</i> in a circle of the best wits
        of the town), is my authority that in Cape Horn, <i>ventre biche</i>, they
        have a rain that will wet through <span data-edition="ed1932" data-page="366"> </span>any, even the stoutest cloak. A
        drenching of that violence, he tells me, <i>sans blague</i>, has sent more
        than one luckless fellow in good earnest posthaste to another world.
        Pooh! A <i>livre!</i> cries Monsieur Lynch. The clumsy things are dear at a
      ...
      <span data-edition="ed1986" data-page="331"> </span><span data-edition="ed1961" data-page="405"> </span>
      <p>
        ...
        is that they use in <button className="bg-gray-300 bg-center bg-cover hover:bg-green-300" onClick={() => openNote("010068themater")}>the Mater
        hospice</button>. Demme, does not Doctor O'Gargle chuck the nuns there under the
        ...
        blood in the <button className="bg-gray-300 bg-center bg-cover hover:bg-green-300" onClick={() => openNote("010103waistcoat")}>primrose vest</button>, feigning a womanish simper and immodest
        ...
        had been pleased to put a <span data-edition="ed1932" data-page="367"> </span>period to the sufferings of the lady who was
        <i>enceinte</i> which she had borne with a laudable fortitude and she had
        ...
        power 
        <span data-edition="ed1939" data-page="292"> </span>
        for happiness upon the earth. I am positive when I say that if
        ...
        have been sown and where no right reverence is <span data-edition="ed1961" data-page="406"> </span>rendered to mother and
        ...
        father and thy mother <span data-edition="ed1986" data-page="332"> </span>that had the best hand to a rolypoly or a hasty
      ...
      <p>
        ...
        some impudent mocks which he however had borne with being the fruits
        of that age upon which it is commonly charged that it knows not
        pity. The young 
        <span data-edition="ed1922" data-page="387"> </span>
        ...
        outrageous <i>mots</i> were such that his intellects resiled from: nor were
        ...
        of wedlock and thrust like a crookback teethed and feet first into the
        world, which the dint of the surgeon's pliers in his skull lent indeed
        a colour to, so as it put him in thought of that missing link of
        creation's chain desiderated by the late ingenious Mr Darwin. It was now
        for more than the middle <span data-edition="ed1932" data-page="368"> </span>span of our allotted years that he had passed
        through the thousand vicissitudes of existence and, being of a wary
        ascendancy and self a man of a rare forecast, he had enjoined his heart
        ...
        the tradition of a proper breeding: while for such that, <span data-edition="ed1961" data-page="407"> </span>having lost
        ...
        upon a speedy delivery he was, however, it must 
        <span data-edition="ed1939" data-page="293"> </span>
      ...
      <p>
        ...
        must acquaint you, <span data-edition="ed1986" data-page="333"> </span>said Mr Crotthers, 
        <span data-edition="ed1922" data-page="388"> </span>
        clapping on the table so as to
        ...
        <span data-edition="ed1932" data-page="369"> </span><button className="bg-gray-300 bg-center bg-cover hover:bg-green-300" onClick={() => openNote("030087pastlife")}>metempsychosis</button> possessed by them, that the puerperal dormitory and the
        ...
        he further added, it <span data-edition="ed1961" data-page="408"> </span>is mayhap to relieve the pentup feelings that in
      ...
      <p>
        ...
        <button className="bg-gray-300 bg-center bg-cover hover:bg-green-300" onClick={() => openNote("030118royaldublins")}>a gallant major</button>, or to cast the most distant reflections upon her
        ...
        angel it had gone with her as hard as with 
        <span data-edition="ed1922" data-page="389"> </span>
        Hagar, the Egyptian! In the
        ...
        retort couched in terms as straightforward as they 
        <span data-edition="ed1939" data-page="294"> </span>
        were bucolic. It ill
        ...
        dispense his <button className="bg-gray-300 bg-center bg-cover hover:bg-green-300" onClick={() => openNote("140003balmofgilead")}>balm of Gilead</button> in <span data-edition="ed1986" data-page="334"> </span>nostrums and apothegms of dubious taste
        ...
        to adduce. The lewd suggestions <span data-edition="ed1932" data-page="370"> </span>of some faded beauty may console him for
        a consort neglected and debauched but this <span data-edition="ed1961" data-page="409"> </span>new exponent of morals and
      ...
      <p>
        ...
        usages of the Sublime Porte by the second female infirmarian to the
        ...
        officer rendered the easier, broke out at once into a strife of
        tongues. In vain the voice of Mr Canvasser Bloom was heard endeavouring
        to urge, to mollify, to restrain. The moment was too propitious for the
        display of that discursiveness which seemed the only band of union among
        ...
        miscarriages and infanticides, simulated and dissimulated, acardiac
        <i>foetus in foetu,</i> aprosopia due to a congestion, the agnathia
        of certain chinless Chinamen (cited by Mr Candidate Mulligan) in
        consequence of 
        <span data-edition="ed1922" data-page="390"> </span>
        ...
        upon the menopause, the problem of the perpetuation of the species <span data-edition="ed1961" data-page="410"> </span>in
        the case of females impregnated by delinquent rape, that distressing
        manner of delivery called by the Brandenburghers <i>Sturzgeburt,</i> the
        recorded instances of multigeminal, twikindled and monstruous births
        conceived <span data-edition="ed1932" data-page="371"> </span>during the catamenic period or of consanguineous parents—{" "}in
        a word all the cases of human nativity which Aristotle has classified
        in his masterpiece with <span data-edition="ed1986" data-page="335"> </span>chromolithographic illustrations. The gravest
        ...
        by her 
        <span data-edition="ed1939" data-page="295"> </span>
        movement, the navelcord should strangle her creature and
        ...
        infants occasionally born. The hypothesis of a <button className="bg-gray-300 bg-center bg-cover hover:bg-green-300" onClick={() => openNote("010079akasicrecords")}>plasmic memory</button>, advanced
        ...
        of brutes, his authority being his own avouchment in support of <button className="bg-gray-300 bg-center bg-cover hover:bg-green-300" onClick={() => openNote("010020ancientgreek")}>fables
        such as that of the Minotaur which the genius of the elegant Latin poet
        has handed down to us in the pages of his Metamorphoses</button>. The impression
        ...
        dilemma in the event of one Siamese twin predeceasing the other,
        <span data-edition="ed1922" data-page="391"> </span>
        ...
        of the <span data-edition="ed1961" data-page="411"> </span>garb with which he was invested or in obedience to an inward
      ...
      <p>
        <button className="bg-gray-300 bg-center bg-cover hover:bg-green-300" onClick={() => openNote("140020talebegan")}>But Malachias' tale began to freeze them with horror.</button> He conjured up the
        scene before them. The secret panel beside the chimney slid back and
        in the recess appeared... <button className="bg-gray-300 bg-center bg-cover hover:bg-green-300" onClick={() => openNote("010023haines")}>Haines!</button> Which of us did not feel his <span data-edition="ed1932" data-page="372"> </span>flesh
        ...
        <button className="bg-gray-300 bg-center bg-cover hover:bg-green-300" onClick={() => openNote("010141blamehistory")}>history is to blame</button>. Yes, it is true. I am the murderer of Samuel
        ...
        (<button className="bg-gray-300 bg-center bg-cover hover:bg-green-300" onClick={() => openNote("010091speakirish")}>he recited some</button>), laudanum (he raised the phial to his lips), camping
        out. In vain! His spectre stalks me. Dope is my only hope... Ah! (<button className="bg-gray-300 bg-center bg-cover hover:bg-green-300" onClick={() => openNote("010025blackpanther")}>The black panther!</button> With a cry he suddenly vanished and the
        ...
        sage repeated: <i>Lex talionis</i>. The sentimentalist is he who would enjoy
        without incurring the immense debtorship for a thing done. Malachias,
        overcome by emotion, ceased. The mystery 
        <span data-edition="ed1939" data-page="296"> </span>
        was unveiled. Haines was the
      ...
      <p>
        ...
        merry and mournful with the downcast, so <span data-edition="ed1961" data-page="412"> </span>too is her age changeable as
        ...
        young Leopold, as in <button className="bg-gray-300 bg-center bg-cover hover:bg-green-300" onClick={() => openNote("060030retrospective")}>a retrospective arrangement</button>, a mirror within
        ...
        house in Clanbrassil street to <button className="bg-gray-300 bg-center bg-cover hover:bg-green-300" onClick={() => openNote("050020highschool")}>the high school</button>, his booksatchel on
        ...
        handkerchief (not for show only), his case <span data-edition="ed1932" data-page="373"> </span>of bright trinketware (alas!
        ...
        the heavy tread of the <span data-edition="ed1986" data-page="337"> </span>watch as two raincaped shadows pass the new royal
        ...
        (<i>fiat</i>!) light shall flood the world. Did heart leap to heart? Nay,
        ...
        loins is by <span data-edition="ed1961" data-page="413"> </span>thee. There is none now to be for Leopold, what Leopold was
        for Rudolph.
      </p>
      <p>
        ...
        dusk, scattering a perennial 
        <span data-edition="ed1922" data-page="393"> </span>
        dew of stars. She follows her mother with
        ...
        phantoms: all is gone. <button className="bg-gray-300 bg-center bg-cover hover:bg-green-300" onClick={() => openNote("040061agendath")}>Agendath</button> is a waste land, a home of
        screechowls and the sandblind upupa. Netaim, the golden, is no more. <button className="bg-gray-300 bg-center bg-cover hover:bg-green-300" onClick={() => openNote("080008parallax")}>And
        ...
        them</button>, the lancinating lightnings of whose brow <span data-edition="ed1932" data-page="374"> </span>are scorpions. Elk and
        yak, the bulls of Bashan and of Babylon, mammoth and mastodon, they come
        trooping to <button className="bg-gray-300 bg-center bg-cover hover:bg-green-300" onClick={() => openNote("040053deadsea")}>the sunken sea, <i>Lacus Mortis</i></button>. Ominous revengeful zodiacal
      ...
      <p>
        ...
        of <button className="bg-gray-300 bg-center bg-cover hover:bg-green-300" onClick={() => openNote("030087pastlife")}>metempsychosis</button>, it is she, the everlasting bride, harbinger of the
        ...
        of cold interstellar wind, winding, coiling, simply swirling,
      ...
      <p>
        Francis was reminding Stephen of years before when they <span data-edition="ed1961" data-page="414"> </span>had been <button className="bg-gray-300 bg-center bg-cover hover:bg-green-300" onClick={() => openNote("050052conmee")}>at
        school together in Conmee's time</button>. He asked about Glaucon, Alcibiades,
        ...
        my call? Who supposes it? I, Bous Stephanoumenos, <button className="bg-gray-300 bg-center bg-cover hover:bg-green-300" onClick={() => openNote("020065bullockbefriending")}>bullockbefriending
        bard</button>, am lord and giver of their life. <button className="bg-gray-300 bg-center bg-cover hover:bg-green-300" onClick={() => openNote("010020ancientgreek")}>He encircled his gadding hair
        with a coronal of vineleaves</button>, smiling at Vincent. That answer and those
        ...
        father. All who wish you well hope this for 
        <span data-edition="ed1922" data-page="394"> </span>
        you. All desire to see
        you bring forth the work you meditate. I
        ...
        fell and, huuh! off, scamper, the mare ran out freshly with O. <span data-edition="ed1932" data-page="375"> </span>Madden
        ...
        <span data-edition="ed1939" data-page="298"> </span>
        said Lenehan, is W. Lane.
        ...
        us were in bloom: <span data-edition="ed1961" data-page="415"> </span>the air drooped with their persuasive odour and with
        ...
        <span data-edition="ed1986" data-page="339"> </span>creature turned all colours in her confusion, feigning to reprove a
        slight disorder in her dress: a slip of 
        <span data-edition="ed1922" data-page="395"> </span>
        underwood clung there for the
        very trees adore her. When Conmee had passed she glanced at her lovely
        echo in the little mirror she carries. But he had been kind. In going
        ...
        Warily, Malachi whispered, preserve a <button className="bg-gray-300 bg-center bg-cover hover:bg-green-300" onClick={() => openNote("010018druids")}>druid</button> silence. His soul is far
      ...
      <p>
        ...
        that conjectured the contrary would have found <span data-edition="ed1961" data-page="416"> </span>themselves pretty
        ...
        before's observations about boyhood days and the turf, <button className="bg-gray-300 bg-center bg-cover hover:bg-green-300" onClick={() => openNote("160008littlepills")}>recollecting two</button>
        <span data-edition="ed1939" data-page="299"> </span>
        <button className="bg-gray-300 bg-center bg-cover hover:bg-green-300" onClick={() => openNote("160008littlepills")}>or three private transactions of his own</button> which the other two were as
        ...
        to help him himself and so he accordingly took hold of the
      ...
      <span data-edition="ed1922" data-page="396"> </span>
      <p>
        ...
        beheld an <span data-edition="ed1986" data-page="340"> </span>assembly so representative and so varied nor had the
        ...
        was <span data-edition="ed1932" data-page="377"> </span>Lynch whose countenance bore already the stigmata of early depravity
        ...
        explorer's kit of tweed shorts and salted cowhide <button className="bg-gray-300 bg-center bg-cover hover:bg-green-300" onClick={() => openNote("020076brogues")}>brogues</button> contrasted
        ...
        inquisition in the <span data-edition="ed1961" data-page="417"> </span>convivial atmosphere of Socratic discussion, while
      ...
      <p>
        It had better be stated here and now at the outset that the <button className="bg-gray-300 bg-center bg-cover hover:bg-green-300" onClick={() => openNote("010041killergod")}>perverted
        transcendentalism</button> to which Mr S. Dedalus' (Div. Scep.) contentions
        ...
        science cannot answer{" "}—{" "}at present{" "}—{" "}such 
        as the first problem submitted
        ...
        a cooperation 
        <span data-edition="ed1922" data-page="397"> </span>
        (one of nature's favourite devices) between the <i>nisus
        formativus</i> of the nemasperm on the one hand and on the other a happily
        chosen position, <i>succubitus felix</i> of the passive element. The other
        problem raised by the same inquirer is scarcely less vital: infant
        mortality. It is interesting because, 
        <span data-edition="ed1939" data-page="300"> </span>
        as he pertinently remarks, we
        ...
        <span data-edition="ed1932" data-page="378"> </span>inhaling the bacteria which lurk in dust. These factors, he alleges,
        and the revolting spectacles offered by our streets, hideous publicity
        posters, <span data-edition="ed1986" data-page="341"> </span>religious ministers of all denominations, mutilated soldiers
        ...
        light philosophy, instructive pictures, <button className="bg-gray-300 bg-center bg-cover hover:bg-green-300" onClick={() => openNote("080005venus")}>plastercast reproductions of
        the classical statues such as Venus and Apollo</button>, artistic coloured
        ...
        <span data-edition="ed1922" data-page="398"> </span>
        ...
        up their residence (modern science has conclusively shown that <button className="bg-gray-300 bg-center bg-cover hover:bg-green-300" onClick={() => openNote("010079akasicrecords")}>only the
        plasmic substance can be said to be immortal</button>) tend to disappear at an
        ...
        that <button className="bg-gray-300 bg-center bg-cover hover:bg-green-300" onClick={() => openNote("010041killergod")}>an omnivorous being which can masticate, deglute, digest and
        apparently pass through the ordinary channel with pluterperfect
        imperturbability</button> such multifarious aliments as cancrenous females
        ...
        relief in an innocent collation of <span data-edition="ed1986" data-page="342"> </span>staggering bob, reveals as nought
        else could and in a very 
        <span data-edition="ed1939" data-page="301"> </span>
        unsavoury light the tendency above alluded to.
        ...
        and 31 Holles street, of which, as is well known, <button className="bg-gray-300 bg-center bg-cover hover:bg-green-300" onClick={() => openNote("140038drhorne")}>Dr A. Horne (Lic. in
        Midw., F. K. Q. C. P. I.) is the able and popular master</button>, he is reported
      ...
      <p>
        ...
        happy <i>accouchement.</i> It had been a weary weary while both for patient
        ...
        before, are happy 
        <span data-edition="ed1922" data-page="399"> </span>
        too as they gaze down and smile upon the touching
        ...
        her dear <span data-edition="ed1961" data-page="420"> </span>Doady there with her to share her joy, to lay in <span data-edition="ed1932" data-page="380"> </span>his arms that
        ...
        Mr Purefoy in <button className="bg-gray-300 bg-center bg-cover hover:bg-green-300" onClick={() => openNote("080013dublincastle")}>the Treasury Remembrancer's office, Dublin Castle</button>. And so
      ...
      <span data-edition="ed1939" data-page="302"> </span>
      <p>
        ...
        <span data-edition="ed1922" data-page="400"> </span>
        under her wrath, not for vengeance to cut him off from the living but shrouded
        in the piteous vesture of the past, silent, remote, reproachful.
      </p>
      <span data-edition="ed1961" data-page="421"> </span>
      <p>
        ...
        disengages itself <span data-edition="ed1932" data-page="381"> </span>in the observer's memory, evoked, it would seem, by
        ...
        from an ear, bringing out <button className="bg-gray-300 bg-center bg-cover hover:bg-green-300" onClick={() => openNote("040063happywarmth")}>the foreign warmth of the skin</button> so daintily
        ...
        <em>piazzetta</em> giving upon the flowerclose with a faint shadow of remoteness
        or of reproach (<i>alles Vergängliche</i>) in her glad look.
      </p>
      <p>
        ...
        custody, rather, <span data-edition="ed1986" data-page="344"> </span>befitting their station in that house, the vigilant
      ...
      <span data-edition="ed1961" data-page="422"> </span>
      <p>
        Burke's! outflings my lord Stephen, giving the cry, and a tag and
        bobtail 
        <span data-edition="ed1922" data-page="401"> </span>
        of all them after, cockerel, jackanapes, welsher, pilldoctor,
        ...
        what not. A dedale of lusty youth, noble every student 
        <span data-edition="ed1939" data-page="303"> </span>
        there. Nurse
        ...
        tumultuously, off for a minute's race, all bravely legging it, <button className="bg-gray-300 bg-center bg-cover hover:bg-green-300" onClick={() => openNote("040089denzille")}>Burke's
        of Denzille and Holles</button> their ulterior goal. Dixon follows giving them
      ...
      <p>
        The air without is <button className="bg-gray-300 bg-center bg-cover hover:bg-green-300" onClick={() => openNote("180010dewy")}>impregnated with raindew moisture</button>, life essence
        ...
        thine!) in the countinghouse? Head up! <button className="bg-gray-300 bg-center bg-cover hover:bg-green-300" onClick={() => openNote("180010dewy")}> For every newbegotten thou shalt
        gather thy homer of ripe wheat. See, thy fleece is drenched</button>. Dost envy
        ...
        pandemonium of ills, enlarged glands, mumps, quinsy, <span data-edition="ed1961" data-page="423"> </span>bunions, hayfever,
        bedsores, ringworm, floating kidney, Derbyshire neck, warts, bilious
        <span data-edition="ed1986" data-page="345"> </span>attacks, gallstones, cold feet, varicose veins. A truce to threnes and
        ...
        lifetask, 
        <span data-edition="ed1922" data-page="402"> </span>
        and didst charge to cover like the transpontine bison. How
        saith Zarathustra? <i>Deine Kuh Trübsal melkest Du. Nun Trinkst Du die
        süsse Milch des Euters</i>. See! it displodes for thee in abundance. Drink,
        ...
        <span data-edition="ed1932" data-page="383"> </span>what? Ay, but her milk is hot and sweet and fattening. No dollop this
        but thick rich bonnyclaber. To her, old patriarch! Pap! <i>Per deam
        Partulam et Pertundam nunc est bibendum</i>!
      </p>
      <p>
        All off for a buster, armstrong, hollering down the street. Bonafides.
        Where you slep las nigh? <button className="bg-gray-300 bg-center bg-cover hover:bg-green-300" onClick={() => openNote("040090naggin")}>Timothy of the battered naggin.</button> Like ole
        ...
        drunken <button className="bg-gray-300 bg-center bg-cover hover:bg-green-300" onClick={() => openNote("010097latinquarterhat")}>minister</button> coming out of the maternity hospal! <i>Benedicat vos
        omnipotens Deus, Pater et Filius</i>. A make, mister. <button className="bg-gray-300 bg-center bg-cover hover:bg-green-300" onClick={() => openNote("040089denzille")}>The Denzille lane
        boys.</button> Hell, blast ye! Scoot. Righto, Isaacs, shove em out of the
        bleeding limelight. 
        ...
        parasangs. Slattery's mounted foot. Where's that bleeding awfur? <button className="bg-gray-300 bg-center bg-cover hover:bg-green-300" onClick={() => openNote("010097latinquarterhat")}>Parson
        Steve</button>, apostates' creed! No, no, Mulligan! Abaft there! Shove ahead.
        ...
        Ayes have it. <button className="bg-gray-300 bg-center bg-cover hover:bg-green-300" onClick={() => openNote("010064dundrum")}>To be printed and bound at the </button><button className="bg-gray-300 bg-center bg-cover hover:bg-green-300" onClick={() => openNote("010018druids")}>Druiddrum</button> press by two
        ...
        and bishops. <span data-edition="ed1961" data-page="424"> </span>Whether on the scaffold high. Beerbeef trample the
      ...
      <p>
        ...
        gone. Yours? Mead of our fathers for <button className="bg-gray-300 bg-center bg-cover hover:bg-green-300" onClick={() => openNote("010129ubermensch")}>the <i>Uebermensch</i></button>. Dittoh. Five
        ...
        again when the old. <button className="bg-gray-300 bg-center bg-cover hover:bg-green-300" onClick={() => openNote("030045absinthe")}>Absinthe</button> for me, savvy? <i>Caramba!</i> Have an eggnog or
        ...
        lovekin. None of your lean kine, not much. Pull down the blind, <span data-edition="ed1932" data-page="384"> </span>love.
        ...
        gluepot. Sir? <button className="bg-gray-300 bg-center bg-cover hover:bg-green-300" onClick={() => openNote("040047potato")}>Spud again the rheumatiz?</button> All poppycock, you'll scuse me
        ...
        Spit in your own eye, boss! <button className="bg-gray-300 bg-center bg-cover hover:bg-green-300" onClick={() => openNote("010043mummer")}>Mummer</button>'s wire. Cribbed out of Meredith.
        Jesified orchidised polycimical <button className="bg-gray-300 bg-center bg-cover hover:bg-green-300" onClick={() => openNote("010008jesuit")}>jesuit</button>! Aunty mine's writing Pa Kinch.
        <button className="bg-gray-300 bg-center bg-cover hover:bg-green-300" onClick={() => openNote("010001buckmulligan")}>Baddybad Stephen lead astray goodygood Malachi.</button>
      </p>
      <p>
        ...
        cove to his gentry mort. <button className="bg-gray-300 bg-center bg-cover hover:bg-green-300" onClick={() => openNote("080005venus")}>Venus Pandemos.</button> <i>Les petites femmes</i>. <button className="bg-gray-300 bg-center bg-cover hover:bg-green-300" onClick={() => openNote("010127photogirl")}>Bold bad
        girl from the town of Mullingar.</button> Tell her I was axing at her. Hauding
        Sara by the wame. On the road to <button className="bg-gray-300 bg-center bg-cover hover:bg-green-300" onClick={() => openNote("030150malahide")}>Malahide</button>. Me? <span data-edition="ed1961" data-page="425"> </span>If she who seduced me had
      ...
      <p>
        ...
        chink <i>ad lib</i>. Seed 
        <span data-edition="ed1939" data-page="305"> </span>
        near free poun on un a spell ago a said war hisn.
        ...
        We're nae the fou. Au reservoir, mossoo. Tanks you.
      </p>
      <span data-edition="ed1922" data-page="404"> </span>
      <p>
        ...
        of cast. Police! Some H<sub>2</sub>O for a gent fainted. Look at Bantam's flowers.
        ...
        big bug Bass to the depot. Shove him <button className="bg-gray-300 bg-center bg-cover hover:bg-green-300" onClick={() => openNote("010019money")}>a joey</button> and grahamise. Mare on form hot 
        ...
        harman beck copped the game. Madden back Madden's a maddening back. <button className="bg-gray-300 bg-center bg-cover hover:bg-green-300" onClick={() => openNote("010088archangelmichael")}>O,
        lust, our refuge and our strength.</button> Decamping. Must you go? Off to mammy.
      ...
      <p>
        ...
        Cut and come again. Right Boniface! <button className="bg-gray-300 bg-center bg-cover hover:bg-green-300" onClick={() => openNote("030045absinthe")}>Absinthe the lot. <i>Nos omnes
        biberimus viridum toxicum diabolus capiat posterioria nostria</i>.</button>
        ...
        low, pardner. Slide. <i>Bonsoir la compagnie</i>. And snares of the poxfiend.
        ...
        licensed spirits. Time. Who wander through the world. Health all!
        <i>A la vôtre</i>!
      </p>
      <span data-edition="ed1922" data-page="405"> </span>
      <p>
        ...
        by James. Wants it real bad. D'ye ken bare socks? Seedy cuss in <button className="bg-gray-300 bg-center bg-cover hover:bg-green-300" onClick={() => openNote("010050dottyville")}>the
        Richmond</button>? Rawthere! Thought he had a deposit of lead in his penis.
        Trumpery insanity. Bartle the Bread we calls him. That, sir, was once
        a prosperous cit. <button className="bg-gray-300 bg-center bg-cover hover:bg-green-300" onClick={() => openNote("140039jackbuilt")}>Man all tattered and torn that married a maiden all
        forlorn.</button> Slung her hook, she did. Here see lost love. Walking Mackintosh
        of lonely canyon. Tuck and turn in. Schedule time. Nix for the hornies.
        Pardon? 
        <span data-edition="ed1939" data-page="306"> </span>
        Seen him today at a runefal? Chum o' yourn <span data-edition="ed1932" data-page="386"> </span>passed in his checks?
        Ludamassy! Pore piccaninnies! Thou'll no be telling me thot, Pold veg!
        Did ums blubble bigsplash crytears cos frien Padney was took off in black
        bag? Of all de darkies Massa Pat was verra best. I never see the like
        since I was born. <i>Tiens, tiens</i>, but it is well sad, that, my faith,
        ...
        any Rooshian. Time all. <span data-edition="ed1986" data-page="348"> </span>There's eleven of them. Get ye gone. Forward,
      ...
      <span data-edition="ed1961" data-page="427"> </span>
      <p>
      ...
      <p>
        Lynch! Hey? Sign on long o me. <button className="bg-gray-300 bg-center bg-cover hover:bg-green-300" onClick={() => openNote("040089denzille")}>Denzille lane this way. Change here for
        Bawdyhouse.</button> We two, she said, will seek the kips where shady Mary is.
        Righto, any old time. <i>Laetabuntur in cubilibus suis</i>. You coming long?
        Whisper, who the sooty hell's the johnny in the black duds? Hush! <button className="bg-gray-300 bg-center bg-cover hover:bg-green-300" onClick={() => openNote("020060jewmerchants")}>Sinned
        against the light</button> and even now that day is at hand when he shall come to
        ...
        extract of infamy! Alexander J Christ Dowie, that's
        yanked to glory most<span data-edition="ed1922" data-page="406"> </span> half this planet from 'Frisco beach to Vladivostok.
      ...
      <br/><br/><br/>
      <span data-edition="ed1922" data-page="407"> </span>
      <span data-edition="ed1932" data-page="387"> </span>
      <span data-edition="ed1939" data-page="307"> </span>
      <span data-edition="ed1961" data-page="428"> </span>
      <span data-edition="ed1986" data-page="349"> </span>		  	
    </div>
  );
}

export default OxenOfTheSun;
